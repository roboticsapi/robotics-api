...
public class OverrideParameterTest {
	...
	public void testRespectBoundsWithItself() {
		OverrideParameter testOverrideParameter = new OverrideParameter(1, Scaling.ABSOLUTE);

		assertTrue(testOverrideParameter.respectsBounds(testOverrideParameter));
	}

	@Test(expected = IllegalArgumentException.class)
	public void testConstructorWithNullDoubleSensorExpectingException() {
		RealtimeDouble mockSensor = null;
