 ...
 * Digital output
 */
public class OutBool extends Primitive {
	/** Type name of the primitive */
	public static final String PRIMITIVE_TYPE = "IO::OutBool";
	...
	private final Parameter<org.roboticsapi.facet.runtime.rpi.core.types.RPIbool> paramIO = new Parameter<org.roboticsapi.facet.runtime.rpi.core.types.RPIbool>(
			"IO", new org.roboticsapi.facet.runtime.rpi.core.types.RPIbool("false"));
	...
	/**
	 * Creates digital output
	 *
	 * @param deviceID Device name IO is connected to
	 * @param port     Port to be used
	 */
	public OutBool(org.roboticsapi.facet.runtime.rpi.core.types.RPIstring paramDeviceID,
	 ...
	 * @param port     Port to be used
	 */
	public OutBool(String paramDeviceID, Integer paramPort) {
	...
	public OutBool(org.roboticsapi.facet.runtime.rpi.core.types.RPIstring paramDeviceID,
			org.roboticsapi.facet.runtime.rpi.core.types.RPIint paramPort,
			org.roboticsapi.facet.runtime.rpi.core.types.RPIbool paramIO) {
		this();
	 ...
	 * @param paramIO       Value to set to output when inIO is not connected
	 */
	public OutBool(String paramDeviceID, Integer paramPort, Boolean paramIO) {
		this(new org.roboticsapi.facet.runtime.rpi.core.types.RPIstring(paramDeviceID),
				new org.roboticsapi.facet.runtime.rpi.core.types.RPIint(paramPort),
				new org.roboticsapi.facet.runtime.rpi.core.types.RPIbool(paramIO));
	}
	 ...
	 * @return the parameter of the block
	 */
	public final Parameter<org.roboticsapi.facet.runtime.rpi.core.types.RPIbool> getIO() {
		return this.paramIO;
	}
	 ...
	 * @param value new value of the parameter
	 */
	public final void setIO(org.roboticsapi.facet.runtime.rpi.core.types.RPIbool value) {
	 ...
	 * @param value new value of the parameter
	 */
	public final void setIO(Boolean value) {
		this.setIO(new org.roboticsapi.facet.runtime.rpi.core.types.RPIbool(value));
	}
