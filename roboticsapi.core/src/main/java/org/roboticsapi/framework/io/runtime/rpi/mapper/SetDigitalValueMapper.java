...
public class SetDigitalValueMapper implements ActionMapper<SetDigitalValue> {

	@Override
	public ActionResult map(SetDigitalValue action, DeviceParameterBag parameters, MapperRegistry registry,
			RealtimeBoolean cancel, RealtimeDouble override, RealtimeDouble time, Map<PlannedAction<?>, Plan> plans)
			throws MappingException, RpiException {

		DigitalValueActionResult ret = new DigitalValueActionResult(action, RealtimeBoolean.TRUE, action.getSensor());
		return ret;
	}
