 ...
 */
public interface DigitalOutputInterface extends ActuatorInterface {
	 ...
	 */
	Activity mirrorValue(RealtimeBoolean sensor) throws RoboticsException;
	 ...
	 */
	Activity setValue(boolean value) throws RoboticsException;
	 ...
	 * @throws RoboticsException if the activity creation fails
	 */
	Activity setValue(RealtimeBoolean sensor) throws RoboticsException;
	 ...
	 */
	Activity setValue(boolean value, double delay) throws RoboticsException;
	 ...
	 * @throws RoboticsException if the activity creation fails
	 */
	Activity setValue(RealtimeBoolean sensor, double delay) throws RoboticsException;
	 ...
	 * @throws RoboticsException thrown if RtActivity creation fails
	 */
	Activity pulse(boolean value, double duration) throws RoboticsException;
