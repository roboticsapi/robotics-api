...
public class MirrorDigitalValueMapper implements ActionMapper<MirrorDigitalValue> {

	@Override
	public ActionResult map(MirrorDigitalValue action, DeviceParameterBag parameters, MapperRegistry registry,
			RealtimeBoolean cancel, RealtimeDouble override, RealtimeDouble time, Map<PlannedAction<?>, Plan> plans)
			throws MappingException, RpiException {
		DigitalValueActionResult ret = new DigitalValueActionResult(action, cancel, action.getSensor());
		return ret;
	}
