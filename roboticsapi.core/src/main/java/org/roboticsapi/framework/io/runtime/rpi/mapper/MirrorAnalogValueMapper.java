...
public class MirrorAnalogValueMapper implements ActionMapper<MirrorAnalogValue> {

	@Override
	public ActionResult map(MirrorAnalogValue action, DeviceParameterBag parameters, MapperRegistry registry,
			RealtimeBoolean cancel, RealtimeDouble override, RealtimeDouble time, Map<PlannedAction<?>, Plan> plans)
			throws MappingException, RpiException {

		AnalogValueActionResult ret = new AnalogValueActionResult(action, cancel, action.getSensor());
		return ret;
	}
}
