...
public class SetAnalogValueMapper implements ActionMapper<SetAnalogValue> {

	@Override
	public ActionResult map(SetAnalogValue action, DeviceParameterBag parameters, MapperRegistry registry,
			RealtimeBoolean cancel, RealtimeDouble override, RealtimeDouble time, Map<PlannedAction<?>, Plan> plans)
			throws MappingException, RpiException {

		AnalogValueActionResult ret = new AnalogValueActionResult(action, RealtimeBoolean.TRUE, action.getSensor());
		return ret;
	}
}
