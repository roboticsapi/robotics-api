...
/**
 * Joint Impedance Setting offers stiffness, damping and additional torque
 */
public class JointImpedanceSettings {
	 ...
	 */
	public JointImpedanceSettings(double stiffness, double damping, double addTorque) {
	 ...
	 */
	public JointImpedanceSettings(double stiffness, double damping, double addTorque, double maxTorque) {
