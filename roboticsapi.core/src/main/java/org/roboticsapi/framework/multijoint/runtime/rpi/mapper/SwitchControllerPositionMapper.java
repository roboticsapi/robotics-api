...
public class SwitchControllerPositionMapper implements ActionMapper<SwitchJointController> {
	...
	public ActionResult map(SwitchJointController action, DeviceParameterBag parameters, MapperRegistry registry,
		...
		if (action.getController().getClass() != JointPositionController.class) {
			return null;
		}

		JointPositionControllerActionResult result = new JointPositionControllerActionResult(action,
				RealtimeBoolean.TRUE);
