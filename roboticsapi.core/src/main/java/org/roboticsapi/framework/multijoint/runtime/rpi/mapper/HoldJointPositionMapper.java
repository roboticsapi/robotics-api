...
public class HoldJointPositionMapper implements ActionMapper<HoldJointPosition> {

	@Override
	public ActionResult map(HoldJointPosition action, DeviceParameterBag parameters, MapperRegistry registry,
			RealtimeBoolean cancel, RealtimeDouble override, RealtimeDouble time, Map<PlannedAction<?>, Plan> plans)
			throws MappingException, RpiException {

		MultiJointActionResult ret = new MultiJointActionResult(action, cancel, Stream.of(action.getPosition())
