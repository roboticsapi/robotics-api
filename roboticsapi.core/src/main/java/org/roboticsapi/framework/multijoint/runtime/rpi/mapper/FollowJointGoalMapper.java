...
public class FollowJointGoalMapper implements ActionMapper<FollowJointGoal> {

	@Override
	public ActionResult map(FollowJointGoal action, DeviceParameterBag parameters, MapperRegistry registry,
			RealtimeBoolean cancel, RealtimeDouble override, RealtimeDouble time, Map<PlannedAction<?>, Plan> plans)
			throws MappingException, RpiException {

		MultiJointActionResult ret = new MultiJointActionResult(action, cancel, Stream.of(action.getGoal())
