...
public class RobotTool {
	...
	protected final Pose centerOfMass;
	protected final double mass;
	protected final double jx;
	protected final double jy;
	protected final double jz;

	public RobotTool(double mass, Pose centerOfMass) {
		this(mass, centerOfMass, 0, 0, 0);
	}

	public RobotTool(double mass, Pose centerOfMass, double jx, double jy, double jz) {
		super();
		this.mass = mass;
