...
public interface StepwiseGrippingInterface extends GrippingInterface {
	 ...
	 *                           created.
	 */
	Activity openForReferencing() throws RoboticsException;
	 ...
	 *                           created.
	 */
	Activity closeForReferencing() throws RoboticsException;
	 ...
	 *                           created.
	 */
	Activity openStepwise(final double width, final GripperParameters... parameters) throws RoboticsException;
	 ...
	 *                           created.
	 */
	Activity closeStepwise(final double width, final GripperParameters... parameters) throws RoboticsException;
	 ...
	 *                           not be created.
	 */
	Activity preposition(final double width, final GripperParameters... parameters) throws RoboticsException;
