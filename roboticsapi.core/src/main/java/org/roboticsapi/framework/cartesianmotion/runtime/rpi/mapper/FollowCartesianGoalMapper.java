...
public class FollowCartesianGoalMapper implements ActionMapper<FollowCartesianGoal> {

	@Override
	public ActionResult map(FollowCartesianGoal action, DeviceParameterBag parameters, MapperRegistry registry,
			RealtimeBoolean cancel, RealtimeDouble override, RealtimeDouble time, Map<PlannedAction<?>, Plan> plans)
			throws MappingException, RpiException {

		CartesianGoalActionResult ret = new CartesianGoalActionResult(action, cancel, action.getGoal());
		return ret;
	}
}
