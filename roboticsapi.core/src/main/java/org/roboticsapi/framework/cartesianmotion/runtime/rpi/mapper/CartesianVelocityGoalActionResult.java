...
public class CartesianVelocityGoalActionResult extends ActionResult {

	private final RealtimeVelocity velocity;

	public CartesianVelocityGoalActionResult(Action action, RealtimeBoolean completion, RealtimeVelocity velocity) {
		super(action, completion);
		this.velocity = velocity;
	}

	public RealtimeVelocity getVelocityGoal() {
		return velocity;
	}
