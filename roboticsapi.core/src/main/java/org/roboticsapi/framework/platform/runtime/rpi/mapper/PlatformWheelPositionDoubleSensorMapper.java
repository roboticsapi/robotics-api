...
public class PlatformWheelPositionDoubleSensorMapper
		extends TypedRealtimeValueFragmentFactory<Double, PlatformWheelPositionRealtimeDouble> {

	public PlatformWheelPositionDoubleSensorMapper() {
		super(PlatformWheelPositionRealtimeDouble.class);
	}

	@Override
	protected RealtimeValueFragment<Double> createFragment(PlatformWheelPositionRealtimeDouble value)
			throws MappingException, RpiException {
		return new RealtimeDoubleFragment(value,
				new WheelMonitor(value.getDriver().getRpiDeviceName(), value.getWheelNumber()).getOutPos());
	}
}
