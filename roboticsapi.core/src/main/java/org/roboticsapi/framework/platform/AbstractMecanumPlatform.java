 ...
 */
public abstract class AbstractMecanumPlatform extends AbstractPlatform<PlatformDriver> implements MecanumPlatform {
	...
	protected final Transformation getMountTransformation(int wheelNumber) {
		...
		case FRONT_LEFT_WHEEL:
			return new Transformation(getWheelOrientation(), getFrontLeftWheelTranslation());

		case FRONT_RIGHT_WHEEL:
			return new Transformation(getWheelOrientation(), getFrontRightWheelTranslation());

		case BACK_LEFT_WHEEL:
			return new Transformation(getWheelOrientation(), getBackLeftWheelTranslation());

		case BACK_RIGHT_WHEEL:
			return new Transformation(getWheelOrientation(), getBackRightWheelTranslation());
	...
	protected final String createMountName(int wheelNumber) {
		switch (wheelNumber) {
		case FRONT_LEFT_WHEEL:
			return "Front left mount frame";

		case FRONT_RIGHT_WHEEL:
			return "Front right mount frame";

		case BACK_LEFT_WHEEL:
			return "Back left mount frame";

		case BACK_RIGHT_WHEEL:
			return "Back right mount frame";
