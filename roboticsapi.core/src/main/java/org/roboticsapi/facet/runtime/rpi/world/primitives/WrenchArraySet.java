 ...
 * Sets an array value.
 */
public class WrenchArraySet extends Primitive {
	/** Type name of the primitive */
	public static final String PRIMITIVE_TYPE = "World::WrenchArraySet";
	 ...
	 */
	public WrenchArraySet(org.roboticsapi.facet.runtime.rpi.core.types.RPIint paramSize,
	 ...
	 * @param index Item index
	 */
	public WrenchArraySet(Integer paramSize, Integer paramIndex) {
