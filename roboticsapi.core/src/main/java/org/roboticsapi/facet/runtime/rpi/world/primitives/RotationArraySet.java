 ...
 * Sets an array value.
 */
public class RotationArraySet extends Primitive {
	/** Type name of the primitive */
	public static final String PRIMITIVE_TYPE = "World::RotationArraySet";
	 ...
	 */
	public RotationArraySet(org.roboticsapi.facet.runtime.rpi.core.types.RPIint paramSize,
	 ...
	 * @param index Item index
	 */
	public RotationArraySet(Integer paramSize, Integer paramIndex) {
