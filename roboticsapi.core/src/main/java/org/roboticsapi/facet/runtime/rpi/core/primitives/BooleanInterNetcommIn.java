 ...
 */
public class BooleanInterNetcommIn extends Primitive {
	/** Type name of the primitive */
	public static final String PRIMITIVE_TYPE = "Core::BooleanInterNetcommIn";
	 ...
	 */
	public BooleanInterNetcommIn(org.roboticsapi.facet.runtime.rpi.core.types.RPIstring paramRemoteRCC,
	 ...
	 * @param remoteKey Key (unique name) of the remote property
	 */
	public BooleanInterNetcommIn(String paramRemoteRCC, String paramRemoteNet, String paramRemoteKey) {
