 ...
 * Creates an array.
 */
public class VectorArray extends Primitive {
	/** Type name of the primitive */
	public static final String PRIMITIVE_TYPE = "World::VectorArray";
	 ...
	 */
	public VectorArray(org.roboticsapi.facet.runtime.rpi.core.types.RPIint paramSize) {
		this();
	 ...
	 * @param size Size of the array
	 */
	public VectorArray(Integer paramSize) {
