...
public class OTG extends Primitive {
	...
	/** Maximum velocity planned by OTG */
	private final Parameter<org.roboticsapi.facet.runtime.rpi.core.types.RPIdouble> paramMaxVel = new Parameter<org.roboticsapi.facet.runtime.rpi.core.types.RPIdouble>(
			"maxVel", new org.roboticsapi.facet.runtime.rpi.core.types.RPIdouble("0"));

	/** Maximum acceleration planned by OTG */
	private final Parameter<org.roboticsapi.facet.runtime.rpi.core.types.RPIdouble> paramMaxAcc = new Parameter<org.roboticsapi.facet.runtime.rpi.core.types.RPIdouble>(
			"maxAcc", new org.roboticsapi.facet.runtime.rpi.core.types.RPIdouble("0"));
	 ...
	 */
	public OTG(org.roboticsapi.facet.runtime.rpi.core.types.RPIdouble paramMaxVel,
			org.roboticsapi.facet.runtime.rpi.core.types.RPIdouble paramMaxAcc) {
		this();
	...
	public OTG(Double paramMaxVel, Double paramMaxAcc) {
		this(new org.roboticsapi.facet.runtime.rpi.core.types.RPIdouble(paramMaxVel),
				new org.roboticsapi.facet.runtime.rpi.core.types.RPIdouble(paramMaxAcc));
	}
	 ...
	 */
	public final Parameter<org.roboticsapi.facet.runtime.rpi.core.types.RPIdouble> getmaxVel() {
	 ...
	 */
	public final void setmaxVel(org.roboticsapi.facet.runtime.rpi.core.types.RPIdouble value) {
	...
	public final void setmaxVel(Double value) {
		this.setmaxVel(new org.roboticsapi.facet.runtime.rpi.core.types.RPIdouble(value));
	}
	 ...
	 * @return the parameter of the block
	 */
	public final Parameter<org.roboticsapi.facet.runtime.rpi.core.types.RPIdouble> getmaxAcc() {
	 ...
	 * @param value new value of the parameter
	 */
	public final void setmaxAcc(org.roboticsapi.facet.runtime.rpi.core.types.RPIdouble value) {
	...
	public final void setmaxAcc(Double value) {
		this.setmaxAcc(new org.roboticsapi.facet.runtime.rpi.core.types.RPIdouble(value));
	}
