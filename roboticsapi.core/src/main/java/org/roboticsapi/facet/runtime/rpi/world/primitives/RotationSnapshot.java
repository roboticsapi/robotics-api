...
public class RotationSnapshot extends Primitive {
	 ...
	 */
	public RotationSnapshot(org.roboticsapi.facet.runtime.rpi.world.types.RPIRotation paramValue) {
		this();
	...
	public RotationSnapshot(String paramValue) {
		this(new org.roboticsapi.facet.runtime.rpi.world.types.RPIRotation(paramValue));
	}
