...
public class TwistFromVelocities extends Primitive {
	...
	/** X rotation velocity */
	private final Parameter<org.roboticsapi.facet.runtime.rpi.core.types.RPIdouble> paramRX = new Parameter<org.roboticsapi.facet.runtime.rpi.core.types.RPIdouble>(
			"RX", new org.roboticsapi.facet.runtime.rpi.core.types.RPIdouble("0"));

	/** Y rotation velocity */
	private final Parameter<org.roboticsapi.facet.runtime.rpi.core.types.RPIdouble> paramRY = new Parameter<org.roboticsapi.facet.runtime.rpi.core.types.RPIdouble>(
			"RY", new org.roboticsapi.facet.runtime.rpi.core.types.RPIdouble("0"));

	/** Z rotation velocity */
	private final Parameter<org.roboticsapi.facet.runtime.rpi.core.types.RPIdouble> paramRZ = new Parameter<org.roboticsapi.facet.runtime.rpi.core.types.RPIdouble>(
			"RZ", new org.roboticsapi.facet.runtime.rpi.core.types.RPIdouble("0"));
	 ...
	 */
	public TwistFromVelocities(org.roboticsapi.facet.runtime.rpi.core.types.RPIdouble paramX,
			...
			org.roboticsapi.facet.runtime.rpi.core.types.RPIdouble paramRX,
			org.roboticsapi.facet.runtime.rpi.core.types.RPIdouble paramRY,
			org.roboticsapi.facet.runtime.rpi.core.types.RPIdouble paramRZ) {
		this();
	...
	public TwistFromVelocities(Double paramX, Double paramY, Double paramZ, Double paramRX, Double paramRY,
		...
		this(new org.roboticsapi.facet.runtime.rpi.core.types.RPIdouble(paramX),
				...
				new org.roboticsapi.facet.runtime.rpi.core.types.RPIdouble(paramRX),
				new org.roboticsapi.facet.runtime.rpi.core.types.RPIdouble(paramRY),
				new org.roboticsapi.facet.runtime.rpi.core.types.RPIdouble(paramRZ));
	}
	 ...
	 * @return the parameter of the block
	 */
	public final Parameter<org.roboticsapi.facet.runtime.rpi.core.types.RPIdouble> getRX() {
		return this.paramRX;
	}
	 ...
	 * @param value new value of the parameter
	 */
	public final void setRX(org.roboticsapi.facet.runtime.rpi.core.types.RPIdouble value) {
	...
	public final void setRX(Double value) {
		this.setRX(new org.roboticsapi.facet.runtime.rpi.core.types.RPIdouble(value));
	}
	 ...
	 * @return the parameter of the block
	 */
	public final Parameter<org.roboticsapi.facet.runtime.rpi.core.types.RPIdouble> getRY() {
		return this.paramRY;
	}
	 ...
	 * @param value new value of the parameter
	 */
	public final void setRY(org.roboticsapi.facet.runtime.rpi.core.types.RPIdouble value) {
	...
	public final void setRY(Double value) {
		this.setRY(new org.roboticsapi.facet.runtime.rpi.core.types.RPIdouble(value));
	}
	 ...
	 * @return the parameter of the block
	 */
	public final Parameter<org.roboticsapi.facet.runtime.rpi.core.types.RPIdouble> getRZ() {
		return this.paramRZ;
	}
	 ...
	 * @param value new value of the parameter
	 */
	public final void setRZ(org.roboticsapi.facet.runtime.rpi.core.types.RPIdouble value) {
	...
	public final void setRZ(Double value) {
		this.setRZ(new org.roboticsapi.facet.runtime.rpi.core.types.RPIdouble(value));
	}
