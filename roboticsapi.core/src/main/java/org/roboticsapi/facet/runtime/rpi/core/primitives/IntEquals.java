...
public class IntEquals extends Primitive {
	...
	/** Allowed difference */
	private final Parameter<org.roboticsapi.facet.runtime.rpi.core.types.RPIint> paramEpsilon = new Parameter<org.roboticsapi.facet.runtime.rpi.core.types.RPIint>(
			"Epsilon", new org.roboticsapi.facet.runtime.rpi.core.types.RPIint("0"));
	 ...
	 */
	public IntEquals(org.roboticsapi.facet.runtime.rpi.core.types.RPIint paramEpsilon) {
		this();
	...
	public IntEquals(Integer paramEpsilon) {
		this(new org.roboticsapi.facet.runtime.rpi.core.types.RPIint(paramEpsilon));
	}
	 ...
	 */
	public IntEquals(org.roboticsapi.facet.runtime.rpi.core.types.RPIint paramFirst,
			org.roboticsapi.facet.runtime.rpi.core.types.RPIint paramSecond,
			org.roboticsapi.facet.runtime.rpi.core.types.RPIint paramEpsilon) {
		this();
	...
	public IntEquals(Integer paramFirst, Integer paramSecond, Integer paramEpsilon) {
		this(new org.roboticsapi.facet.runtime.rpi.core.types.RPIint(paramFirst),
				...
				new org.roboticsapi.facet.runtime.rpi.core.types.RPIint(paramEpsilon));
	}
	 ...
	 * @return the parameter of the block
	 */
	public final Parameter<org.roboticsapi.facet.runtime.rpi.core.types.RPIint> getEpsilon() {
	 ...
	 * @param value new value of the parameter
	 */
	public final void setEpsilon(org.roboticsapi.facet.runtime.rpi.core.types.RPIint value) {
	...
	public final void setEpsilon(Integer value) {
		this.setEpsilon(new org.roboticsapi.facet.runtime.rpi.core.types.RPIint(value));
	}
