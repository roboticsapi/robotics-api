...
import org.roboticsapi.facet.runtime.rpi.core.primitives.BooleanNetcommOut;
import org.roboticsapi.facet.runtime.rpi.core.types.RPIstring;

/**
 * Communication module to read value from net
 */
public class ReadBoolFromNet extends BooleanNetcommOut implements NetcommPrimitive {
	 ...
	 */
	public ReadBoolFromNet(final String key) {
		super(key);
