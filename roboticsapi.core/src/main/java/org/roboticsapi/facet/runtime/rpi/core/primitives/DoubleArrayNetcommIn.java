 ...
 */
public class DoubleArrayNetcommIn extends Primitive {
	/** Type name of the primitive */
	public static final String PRIMITIVE_TYPE = "Core::DoubleArrayNetcommIn";
	 ...
	 */
	public DoubleArrayNetcommIn(org.roboticsapi.facet.runtime.rpi.core.types.RPIstring paramKey,
	 ...
	 * @param value Initial value to write to net
	 */
	public DoubleArrayNetcommIn(String paramKey, String paramValue) {
