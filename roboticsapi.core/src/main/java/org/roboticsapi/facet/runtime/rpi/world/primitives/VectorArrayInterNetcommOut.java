 ...
 */
public class VectorArrayInterNetcommOut extends Primitive {
	/** Type name of the primitive */
	public static final String PRIMITIVE_TYPE = "World::VectorArrayInterNetcommOut";
	...
	public VectorArrayInterNetcommOut() {
	 ...
	 */
	public VectorArrayInterNetcommOut(org.roboticsapi.facet.runtime.rpi.core.types.RPIstring paramRemoteRCC,
	 ...
	 * @param remoteKey Key (unique name) of the remote property
	 */
	public VectorArrayInterNetcommOut(String paramRemoteRCC, String paramRemoteNet, String paramRemoteKey) {
