...
public class DoubleEquals extends Primitive {
	...
	/** Allowed difference */
	private final Parameter<org.roboticsapi.facet.runtime.rpi.core.types.RPIdouble> paramEpsilon = new Parameter<org.roboticsapi.facet.runtime.rpi.core.types.RPIdouble>(
			"Epsilon", new org.roboticsapi.facet.runtime.rpi.core.types.RPIdouble("0"));
	 ...
	 */
	public DoubleEquals(org.roboticsapi.facet.runtime.rpi.core.types.RPIdouble paramEpsilon) {
		this();
	...
	public DoubleEquals(Double paramEpsilon) {
		this(new org.roboticsapi.facet.runtime.rpi.core.types.RPIdouble(paramEpsilon));
	}
	 ...
	 */
	public DoubleEquals(org.roboticsapi.facet.runtime.rpi.core.types.RPIdouble paramFirst,
			org.roboticsapi.facet.runtime.rpi.core.types.RPIdouble paramSecond,
			org.roboticsapi.facet.runtime.rpi.core.types.RPIdouble paramEpsilon) {
		this();
	...
	public DoubleEquals(Double paramFirst, Double paramSecond, Double paramEpsilon) {
		this(new org.roboticsapi.facet.runtime.rpi.core.types.RPIdouble(paramFirst),
				...
				new org.roboticsapi.facet.runtime.rpi.core.types.RPIdouble(paramEpsilon));
	}
	 ...
	 * @return the parameter of the block
	 */
	public final Parameter<org.roboticsapi.facet.runtime.rpi.core.types.RPIdouble> getEpsilon() {
	 ...
	 * @param value new value of the parameter
	 */
	public final void setEpsilon(org.roboticsapi.facet.runtime.rpi.core.types.RPIdouble value) {
	...
	public final void setEpsilon(Double value) {
		this.setEpsilon(new org.roboticsapi.facet.runtime.rpi.core.types.RPIdouble(value));
	}
