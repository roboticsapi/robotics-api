 ...
 * Sets an array value.
 */
public class FrameArraySet extends Primitive {
	/** Type name of the primitive */
	public static final String PRIMITIVE_TYPE = "World::FrameArraySet";
	 ...
	 */
	public FrameArraySet(org.roboticsapi.facet.runtime.rpi.core.types.RPIint paramSize,
	 ...
	 * @param index Item index
	 */
	public FrameArraySet(Integer paramSize, Integer paramIndex) {
