 ...
 */
public class IntAtTime extends Primitive {
	/** Type name of the primitive */
	public static final String PRIMITIVE_TYPE = "Core::IntAtTime";
	 ...
	 */
	public IntAtTime(org.roboticsapi.facet.runtime.rpi.core.types.RPIdouble paramMaxAge) {
		this();
	 ...
	 * @param maxAge Maximum age supported (s)
	 */
	public IntAtTime(Double paramMaxAge) {
	 ...
	 */
	public IntAtTime(org.roboticsapi.facet.runtime.rpi.core.types.RPIdouble paramAge,
	 ...
	 * @param paramMaxAge Maximum age supported (s)
	 */
	public IntAtTime(Double paramAge, Double paramMaxAge) {
