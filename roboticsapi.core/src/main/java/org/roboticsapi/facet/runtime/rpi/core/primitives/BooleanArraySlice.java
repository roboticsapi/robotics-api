 ...
 */
public class BooleanArraySlice extends Primitive {
	/** Type name of the primitive */
	public static final String PRIMITIVE_TYPE = "Core::BooleanArraySlice";
	 ...
	 */
	public BooleanArraySlice(org.roboticsapi.facet.runtime.rpi.core.types.RPIint paramSize,
	 ...
	 * @param start Start index
	 */
	public BooleanArraySlice(Integer paramSize, Integer paramStart) {
