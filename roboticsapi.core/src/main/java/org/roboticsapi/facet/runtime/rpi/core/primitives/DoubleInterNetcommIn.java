 ...
 */
public class DoubleInterNetcommIn extends Primitive {
	/** Type name of the primitive */
	public static final String PRIMITIVE_TYPE = "Core::DoubleInterNetcommIn";
	 ...
	 */
	public DoubleInterNetcommIn(org.roboticsapi.facet.runtime.rpi.core.types.RPIstring paramRemoteRCC,
	 ...
	 * @param remoteKey Key (unique name) of the remote property
	 */
	public DoubleInterNetcommIn(String paramRemoteRCC, String paramRemoteNet, String paramRemoteKey) {
