 ...
 */
public class RotationInterNetcommOut extends Primitive {
	/** Type name of the primitive */
	public static final String PRIMITIVE_TYPE = "World::RotationInterNetcommOut";
	...
	public RotationInterNetcommOut() {
	 ...
	 */
	public RotationInterNetcommOut(org.roboticsapi.facet.runtime.rpi.core.types.RPIstring paramRemoteRCC,
	 ...
	 * @param remoteKey Key (unique name) of the remote property
	 */
	public RotationInterNetcommOut(String paramRemoteRCC, String paramRemoteNet, String paramRemoteKey) {
