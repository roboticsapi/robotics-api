 ...
 */
public class WrenchInterNetcommOut extends Primitive {
	/** Type name of the primitive */
	public static final String PRIMITIVE_TYPE = "World::WrenchInterNetcommOut";
	 ...
	 */
	public WrenchInterNetcommOut(org.roboticsapi.facet.runtime.rpi.core.types.RPIstring paramRemoteRCC,
	 ...
	 * @param remoteKey Key (unique name) of the remote property
	 */
	public WrenchInterNetcommOut(String paramRemoteRCC, String paramRemoteNet, String paramRemoteKey) {
