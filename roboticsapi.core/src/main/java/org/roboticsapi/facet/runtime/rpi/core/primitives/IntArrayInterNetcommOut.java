 ...
 */
public class IntArrayInterNetcommOut extends Primitive {
	/** Type name of the primitive */
	public static final String PRIMITIVE_TYPE = "Core::IntArrayInterNetcommOut";
	...
	public IntArrayInterNetcommOut() {
	 ...
	 */
	public IntArrayInterNetcommOut(org.roboticsapi.facet.runtime.rpi.core.types.RPIstring paramRemoteRCC,
	 ...
	 * @param remoteKey Key (unique name) of the remote property
	 */
	public IntArrayInterNetcommOut(String paramRemoteRCC, String paramRemoteNet, String paramRemoteKey) {
