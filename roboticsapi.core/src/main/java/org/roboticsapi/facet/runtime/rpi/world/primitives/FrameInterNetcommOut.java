 ...
 */
public class FrameInterNetcommOut extends Primitive {
	/** Type name of the primitive */
	public static final String PRIMITIVE_TYPE = "World::FrameInterNetcommOut";
	 ...
	 */
	public FrameInterNetcommOut(org.roboticsapi.facet.runtime.rpi.core.types.RPIstring paramRemoteRCC,
	 ...
	 * @param remoteKey Key (unique name) of the remote property
	 */
	public FrameInterNetcommOut(String paramRemoteRCC, String paramRemoteNet, String paramRemoteKey) {
