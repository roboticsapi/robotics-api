 ...
 */
public class TwistArrayInterNetcommIn extends Primitive {
	/** Type name of the primitive */
	public static final String PRIMITIVE_TYPE = "World::TwistArrayInterNetcommIn";
	...
	public TwistArrayInterNetcommIn() {
	 ...
	 */
	public TwistArrayInterNetcommIn(org.roboticsapi.facet.runtime.rpi.core.types.RPIstring paramRemoteRCC,
	 ...
	 * @param remoteKey Key (unique name) of the remote property
	 */
	public TwistArrayInterNetcommIn(String paramRemoteRCC, String paramRemoteNet, String paramRemoteKey) {
