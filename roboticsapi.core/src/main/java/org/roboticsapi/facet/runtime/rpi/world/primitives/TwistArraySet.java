 ...
 * Sets an array value.
 */
public class TwistArraySet extends Primitive {
	/** Type name of the primitive */
	public static final String PRIMITIVE_TYPE = "World::TwistArraySet";
	 ...
	 */
	public TwistArraySet(org.roboticsapi.facet.runtime.rpi.core.types.RPIint paramSize,
	 ...
	 * @param index Item index
	 */
	public TwistArraySet(Integer paramSize, Integer paramIndex) {
