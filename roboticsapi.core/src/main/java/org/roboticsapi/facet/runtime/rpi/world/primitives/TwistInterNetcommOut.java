 ...
 */
public class TwistInterNetcommOut extends Primitive {
	/** Type name of the primitive */
	public static final String PRIMITIVE_TYPE = "World::TwistInterNetcommOut";
	 ...
	 */
	public TwistInterNetcommOut(org.roboticsapi.facet.runtime.rpi.core.types.RPIstring paramRemoteRCC,
	 ...
	 * @param remoteKey Key (unique name) of the remote property
	 */
	public TwistInterNetcommOut(String paramRemoteRCC, String paramRemoteNet, String paramRemoteKey) {
