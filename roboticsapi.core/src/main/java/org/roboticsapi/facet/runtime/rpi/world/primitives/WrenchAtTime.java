 ...
 */
public class WrenchAtTime extends Primitive {
	/** Type name of the primitive */
	public static final String PRIMITIVE_TYPE = "World::WrenchAtTime";
	 ...
	 */
	public WrenchAtTime(org.roboticsapi.facet.runtime.rpi.core.types.RPIdouble paramMaxAge) {
		this();
	 ...
	 * @param maxAge Maximum age supported (s)
	 */
	public WrenchAtTime(Double paramMaxAge) {
	 ...
	 */
	public WrenchAtTime(org.roboticsapi.facet.runtime.rpi.core.types.RPIdouble paramAge,
	 ...
	 * @param paramMaxAge Maximum age supported (s)
	 */
	public WrenchAtTime(Double paramAge, Double paramMaxAge) {
