 ...
 */
public class BooleanArrayGet extends Primitive {
	/** Type name of the primitive */
	public static final String PRIMITIVE_TYPE = "Core::BooleanArrayGet";
	 ...
	 */
	public BooleanArrayGet(org.roboticsapi.facet.runtime.rpi.core.types.RPIint paramSize,
	 ...
	 * @param index Item index
	 */
	public BooleanArrayGet(Integer paramSize, Integer paramIndex) {
