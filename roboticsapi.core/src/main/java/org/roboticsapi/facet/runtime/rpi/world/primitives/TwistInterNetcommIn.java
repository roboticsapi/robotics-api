 ...
 */
public class TwistInterNetcommIn extends Primitive {
	/** Type name of the primitive */
	public static final String PRIMITIVE_TYPE = "World::TwistInterNetcommIn";
	 ...
	 */
	public TwistInterNetcommIn(org.roboticsapi.facet.runtime.rpi.core.types.RPIstring paramRemoteRCC,
	 ...
	 * @param remoteKey Key (unique name) of the remote property
	 */
	public TwistInterNetcommIn(String paramRemoteRCC, String paramRemoteNet, String paramRemoteKey) {
