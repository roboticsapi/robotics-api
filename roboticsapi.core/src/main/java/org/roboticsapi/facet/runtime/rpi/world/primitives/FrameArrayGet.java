 ...
 */
public class FrameArrayGet extends Primitive {
	/** Type name of the primitive */
	public static final String PRIMITIVE_TYPE = "World::FrameArrayGet";
	 ...
	 */
	public FrameArrayGet(org.roboticsapi.facet.runtime.rpi.core.types.RPIint paramSize,
	 ...
	 * @param index Item index
	 */
	public FrameArrayGet(Integer paramSize, Integer paramIndex) {
