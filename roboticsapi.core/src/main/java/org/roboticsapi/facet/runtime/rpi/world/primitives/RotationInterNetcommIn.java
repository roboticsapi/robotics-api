 ...
 */
public class RotationInterNetcommIn extends Primitive {
	/** Type name of the primitive */
	public static final String PRIMITIVE_TYPE = "World::RotationInterNetcommIn";
	 ...
	 */
	public RotationInterNetcommIn(org.roboticsapi.facet.runtime.rpi.core.types.RPIstring paramRemoteRCC,
	 ...
	 * @param remoteKey Key (unique name) of the remote property
	 */
	public RotationInterNetcommIn(String paramRemoteRCC, String paramRemoteNet, String paramRemoteKey) {
