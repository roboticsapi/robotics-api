 ...
 * Creates an array.
 */
public class FrameArray extends Primitive {
	/** Type name of the primitive */
	public static final String PRIMITIVE_TYPE = "World::FrameArray";
	 ...
	 */
	public FrameArray(org.roboticsapi.facet.runtime.rpi.core.types.RPIint paramSize) {
		this();
	 ...
	 * @param size Size of the array
	 */
	public FrameArray(Integer paramSize) {
