 ...
 */
public class RotationArrayGet extends Primitive {
	/** Type name of the primitive */
	public static final String PRIMITIVE_TYPE = "World::RotationArrayGet";
	 ...
	 */
	public RotationArrayGet(org.roboticsapi.facet.runtime.rpi.core.types.RPIint paramSize,
	 ...
	 * @param index Item index
	 */
	public RotationArrayGet(Integer paramSize, Integer paramIndex) {
