 ...
 */
public class FrameArraySlice extends Primitive {
	/** Type name of the primitive */
	public static final String PRIMITIVE_TYPE = "World::FrameArraySlice";
	 ...
	 */
	public FrameArraySlice(org.roboticsapi.facet.runtime.rpi.core.types.RPIint paramSize,
	 ...
	 * @param start Start index
	 */
	public FrameArraySlice(Integer paramSize, Integer paramStart) {
