 ...
 */
public class RotationArraySlice extends Primitive {
	/** Type name of the primitive */
	public static final String PRIMITIVE_TYPE = "World::RotationArraySlice";
	 ...
	 */
	public RotationArraySlice(org.roboticsapi.facet.runtime.rpi.core.types.RPIint paramSize,
	 ...
	 * @param start Start index
	 */
	public RotationArraySlice(Integer paramSize, Integer paramStart) {
