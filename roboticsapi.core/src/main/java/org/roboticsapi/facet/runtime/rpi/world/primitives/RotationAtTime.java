 ...
 */
public class RotationAtTime extends Primitive {
	/** Type name of the primitive */
	public static final String PRIMITIVE_TYPE = "World::RotationAtTime";
	 ...
	 */
	public RotationAtTime(org.roboticsapi.facet.runtime.rpi.core.types.RPIdouble paramMaxAge) {
		this();
	 ...
	 * @param maxAge Maximum age supported (s)
	 */
	public RotationAtTime(Double paramMaxAge) {
	 ...
	 */
	public RotationAtTime(org.roboticsapi.facet.runtime.rpi.core.types.RPIdouble paramAge,
	 ...
	 * @param paramMaxAge Maximum age supported (s)
	 */
	public RotationAtTime(Double paramAge, Double paramMaxAge) {
