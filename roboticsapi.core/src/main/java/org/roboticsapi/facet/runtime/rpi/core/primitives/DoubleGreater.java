 ...
 * A comparison module
 */
public class DoubleGreater extends Primitive {
	/** Type name of the primitive */
	public static final String PRIMITIVE_TYPE = "Core::DoubleGreater";
	 ...
	 */
	public DoubleGreater(org.roboticsapi.facet.runtime.rpi.core.types.RPIdouble paramFirst,
	 ...
	 * @param paramSecond Second value
	 */
	public DoubleGreater(Double paramFirst, Double paramSecond) {
