 ...
 */
public class VectorArrayNetcommIn extends Primitive {
	/** Type name of the primitive */
	public static final String PRIMITIVE_TYPE = "World::VectorArrayNetcommIn";
	...
	private final Parameter<org.roboticsapi.facet.runtime.rpi.world.types.RPIVectorArray> paramValue = new Parameter<org.roboticsapi.facet.runtime.rpi.world.types.RPIVectorArray>(
			"Value", new org.roboticsapi.facet.runtime.rpi.world.types.RPIVectorArray("[]"));

	public VectorArrayNetcommIn() {
	 ...
	 */
	public VectorArrayNetcommIn(org.roboticsapi.facet.runtime.rpi.core.types.RPIstring paramKey,
			org.roboticsapi.facet.runtime.rpi.world.types.RPIVectorArray paramValue) {
		this();
	 ...
	 * @param value Initial value to write to net
	 */
	public VectorArrayNetcommIn(String paramKey, String paramValue) {
		this(new org.roboticsapi.facet.runtime.rpi.core.types.RPIstring(paramKey),
				new org.roboticsapi.facet.runtime.rpi.world.types.RPIVectorArray(paramValue));
	}
	 ...
	 * @return the parameter of the block
	 */
	public final Parameter<org.roboticsapi.facet.runtime.rpi.world.types.RPIVectorArray> getValue() {
	 ...
	 * @param value new value of the parameter
	 */
	public final void setValue(org.roboticsapi.facet.runtime.rpi.world.types.RPIVectorArray value) {
	...
	public final void setValue(String value) {
		this.setValue(new org.roboticsapi.facet.runtime.rpi.world.types.RPIVectorArray(value));
	}
