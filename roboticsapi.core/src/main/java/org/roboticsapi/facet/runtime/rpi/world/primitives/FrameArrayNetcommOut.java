 ...
 */
public class FrameArrayNetcommOut extends Primitive {
	/** Type name of the primitive */
	public static final String PRIMITIVE_TYPE = "World::FrameArrayNetcommOut";
	...
	private final Parameter<org.roboticsapi.facet.runtime.rpi.world.types.RPIFrameArray> paramValue = new Parameter<org.roboticsapi.facet.runtime.rpi.world.types.RPIFrameArray>(
			"Value", new org.roboticsapi.facet.runtime.rpi.world.types.RPIFrameArray("[]"));

	public FrameArrayNetcommOut() {
	 ...
	 */
	public FrameArrayNetcommOut(org.roboticsapi.facet.runtime.rpi.core.types.RPIstring paramKey) {
		this();
	 ...
	 * @param key Key (unique name) of the property
	 */
	public FrameArrayNetcommOut(String paramKey) {
	 ...
	 */
	public FrameArrayNetcommOut(org.roboticsapi.facet.runtime.rpi.core.types.RPIstring paramKey,
			org.roboticsapi.facet.runtime.rpi.world.types.RPIFrameArray paramValue) {
		this();
	 ...
	 * @param paramValue Initial value to read from net
	 */
	public FrameArrayNetcommOut(String paramKey, String paramValue) {
		this(new org.roboticsapi.facet.runtime.rpi.core.types.RPIstring(paramKey),
				new org.roboticsapi.facet.runtime.rpi.world.types.RPIFrameArray(paramValue));
	}
	 ...
	 * @return the parameter of the block
	 */
	public final Parameter<org.roboticsapi.facet.runtime.rpi.world.types.RPIFrameArray> getValue() {
	 ...
	 * @param value new value of the parameter
	 */
	public final void setValue(org.roboticsapi.facet.runtime.rpi.world.types.RPIFrameArray value) {
	...
	public final void setValue(String value) {
		this.setValue(new org.roboticsapi.facet.runtime.rpi.world.types.RPIFrameArray(value));
	}
