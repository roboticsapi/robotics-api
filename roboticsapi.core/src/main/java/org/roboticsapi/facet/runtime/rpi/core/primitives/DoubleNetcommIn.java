 ...
 */
public class DoubleNetcommIn extends Primitive {
	/** Type name of the primitive */
	public static final String PRIMITIVE_TYPE = "Core::DoubleNetcommIn";
	 ...
	 */
	public DoubleNetcommIn(org.roboticsapi.facet.runtime.rpi.core.types.RPIstring paramKey,
			org.roboticsapi.facet.runtime.rpi.core.types.RPIdouble paramValue) {
		this();
	 ...
	 * @param value Initial value to write to net
	 */
	public DoubleNetcommIn(String paramKey, Double paramValue) {
		this(new org.roboticsapi.facet.runtime.rpi.core.types.RPIstring(paramKey),
				new org.roboticsapi.facet.runtime.rpi.core.types.RPIdouble(paramValue));
	}
