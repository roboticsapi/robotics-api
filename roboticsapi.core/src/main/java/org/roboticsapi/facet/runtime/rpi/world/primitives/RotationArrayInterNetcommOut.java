 ...
 */
public class RotationArrayInterNetcommOut extends Primitive {
	/** Type name of the primitive */
	public static final String PRIMITIVE_TYPE = "World::RotationArrayInterNetcommOut";
	...
	public RotationArrayInterNetcommOut() {
	 ...
	 */
	public RotationArrayInterNetcommOut(org.roboticsapi.facet.runtime.rpi.core.types.RPIstring paramRemoteRCC,
	 ...
	 * @param remoteKey Key (unique name) of the remote property
	 */
	public RotationArrayInterNetcommOut(String paramRemoteRCC, String paramRemoteNet, String paramRemoteKey) {
