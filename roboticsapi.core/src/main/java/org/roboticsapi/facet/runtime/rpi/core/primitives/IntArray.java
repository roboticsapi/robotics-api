 ...
 * Creates an array.
 */
public class IntArray extends Primitive {
	/** Type name of the primitive */
	public static final String PRIMITIVE_TYPE = "Core::IntArray";
	 ...
	 */
	public IntArray(org.roboticsapi.facet.runtime.rpi.core.types.RPIint paramSize) {
		this();
	 ...
	 * @param size Size of the array
	 */
	public IntArray(Integer paramSize) {
