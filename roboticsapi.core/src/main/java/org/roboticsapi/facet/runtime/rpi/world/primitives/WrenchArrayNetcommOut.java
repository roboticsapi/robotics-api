 ...
 */
public class WrenchArrayNetcommOut extends Primitive {
	/** Type name of the primitive */
	public static final String PRIMITIVE_TYPE = "World::WrenchArrayNetcommOut";
	...
	private final Parameter<org.roboticsapi.facet.runtime.rpi.world.types.RPIWrenchArray> paramValue = new Parameter<org.roboticsapi.facet.runtime.rpi.world.types.RPIWrenchArray>(
			"Value", new org.roboticsapi.facet.runtime.rpi.world.types.RPIWrenchArray("[]"));

	public WrenchArrayNetcommOut() {
	 ...
	 */
	public WrenchArrayNetcommOut(org.roboticsapi.facet.runtime.rpi.core.types.RPIstring paramKey) {
		this();
	 ...
	 * @param key Key (unique name) of the property
	 */
	public WrenchArrayNetcommOut(String paramKey) {
	 ...
	 */
	public WrenchArrayNetcommOut(org.roboticsapi.facet.runtime.rpi.core.types.RPIstring paramKey,
			org.roboticsapi.facet.runtime.rpi.world.types.RPIWrenchArray paramValue) {
		this();
	 ...
	 * @param paramValue Initial value to read from net
	 */
	public WrenchArrayNetcommOut(String paramKey, String paramValue) {
		this(new org.roboticsapi.facet.runtime.rpi.core.types.RPIstring(paramKey),
				new org.roboticsapi.facet.runtime.rpi.world.types.RPIWrenchArray(paramValue));
	}
	 ...
	 * @return the parameter of the block
	 */
	public final Parameter<org.roboticsapi.facet.runtime.rpi.world.types.RPIWrenchArray> getValue() {
	 ...
	 * @param value new value of the parameter
	 */
	public final void setValue(org.roboticsapi.facet.runtime.rpi.world.types.RPIWrenchArray value) {
	...
	public final void setValue(String value) {
		this.setValue(new org.roboticsapi.facet.runtime.rpi.world.types.RPIWrenchArray(value));
	}
