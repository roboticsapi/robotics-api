 ...
 * An addition module
 */
public class DoubleAdd extends Primitive {
	/** Type name of the primitive */
	public static final String PRIMITIVE_TYPE = "Core::DoubleAdd";
	 ...
	 */
	public DoubleAdd(org.roboticsapi.facet.runtime.rpi.core.types.RPIdouble paramFirst,
	 ...
	 * @param paramSecond Second value
	 */
	public DoubleAdd(Double paramFirst, Double paramSecond) {
