...
public class RPIWrench extends ComplexType {
	...
	private org.roboticsapi.facet.runtime.rpi.world.types.RPIVector force = new org.roboticsapi.facet.runtime.rpi.world.types.RPIVector();
	private org.roboticsapi.facet.runtime.rpi.world.types.RPIVector torque = new org.roboticsapi.facet.runtime.rpi.world.types.RPIVector();
	 ...
	 */
	public RPIWrench(org.roboticsapi.facet.runtime.rpi.world.types.RPIVector force,
			org.roboticsapi.facet.runtime.rpi.world.types.RPIVector torque) {
		this.force = force;
		this.torque = torque;
	}
	 ...
	 */
	public void setForce(org.roboticsapi.facet.runtime.rpi.world.types.RPIVector value) {
		this.force = value;
	}
	 ...
	 */
	public org.roboticsapi.facet.runtime.rpi.world.types.RPIVector getForce() {
		return force;
	}
	 ...
	 * @param value The new value
	 */
	public void setTorque(org.roboticsapi.facet.runtime.rpi.world.types.RPIVector value) {
		this.torque = value;
	}
	 ...
	 * @return The current value
	 */
	public org.roboticsapi.facet.runtime.rpi.world.types.RPIVector getTorque() {
		return torque;
	}
