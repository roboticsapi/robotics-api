 ...
 */
public class RotationArrayInterNetcommIn extends Primitive {
	/** Type name of the primitive */
	public static final String PRIMITIVE_TYPE = "World::RotationArrayInterNetcommIn";
	...
	public RotationArrayInterNetcommIn() {
	 ...
	 */
	public RotationArrayInterNetcommIn(org.roboticsapi.facet.runtime.rpi.core.types.RPIstring paramRemoteRCC,
	 ...
	 * @param remoteKey Key (unique name) of the remote property
	 */
	public RotationArrayInterNetcommIn(String paramRemoteRCC, String paramRemoteNet, String paramRemoteKey) {
