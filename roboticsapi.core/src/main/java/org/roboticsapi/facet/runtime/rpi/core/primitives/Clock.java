...
public class Clock extends Primitive {
	...
	/** Increment per second */
	private final Parameter<org.roboticsapi.facet.runtime.rpi.core.types.RPIdouble> paramIncrement = new Parameter<org.roboticsapi.facet.runtime.rpi.core.types.RPIdouble>(
			"Increment", new org.roboticsapi.facet.runtime.rpi.core.types.RPIdouble("1"));
	 ...
	 */
	public Clock(org.roboticsapi.facet.runtime.rpi.core.types.RPIdouble paramIncrement) {
		this();
	...
	public Clock(Double paramIncrement) {
		this(new org.roboticsapi.facet.runtime.rpi.core.types.RPIdouble(paramIncrement));
	}
	 ...
	 */
	public final Parameter<org.roboticsapi.facet.runtime.rpi.core.types.RPIdouble> getIncrement() {
	 ...
	 */
	public final void setIncrement(org.roboticsapi.facet.runtime.rpi.core.types.RPIdouble value) {
	...
	public final void setIncrement(Double value) {
		this.setIncrement(new org.roboticsapi.facet.runtime.rpi.core.types.RPIdouble(value));
	}
