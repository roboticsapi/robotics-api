...
/**
 * A Boolean and module
 */
public class BooleanAnd extends Primitive {
	/** Type name of the primitive */
	public static final String PRIMITIVE_TYPE = "Core::BooleanAnd";
	...
	private final Parameter<org.roboticsapi.facet.runtime.rpi.core.types.RPIbool> paramFirst = new Parameter<org.roboticsapi.facet.runtime.rpi.core.types.RPIbool>(
			"First", new org.roboticsapi.facet.runtime.rpi.core.types.RPIbool("true"));
	...
	private final Parameter<org.roboticsapi.facet.runtime.rpi.core.types.RPIbool> paramSecond = new Parameter<org.roboticsapi.facet.runtime.rpi.core.types.RPIbool>(
			"Second", new org.roboticsapi.facet.runtime.rpi.core.types.RPIbool("true"));
	...
	/**
	 * Creates a Boolean and module
	 *
	 * @param paramFirst  First value
	 * @param paramSecond Second value
	 */
	public BooleanAnd(org.roboticsapi.facet.runtime.rpi.core.types.RPIbool paramFirst,
	 ...
	 * @param paramSecond Second value
	 */
	public BooleanAnd(Boolean paramFirst, Boolean paramSecond) {
