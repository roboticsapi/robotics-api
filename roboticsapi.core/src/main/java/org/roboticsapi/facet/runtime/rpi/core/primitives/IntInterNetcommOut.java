 ...
 */
public class IntInterNetcommOut extends Primitive {
	/** Type name of the primitive */
	public static final String PRIMITIVE_TYPE = "Core::IntInterNetcommOut";
	 ...
	 */
	public IntInterNetcommOut(org.roboticsapi.facet.runtime.rpi.core.types.RPIstring paramRemoteRCC,
	 ...
	 * @param remoteKey Key (unique name) of the remote property
	 */
	public IntInterNetcommOut(String paramRemoteRCC, String paramRemoteNet, String paramRemoteKey) {
