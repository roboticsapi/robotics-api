 ...
 */
public class VectorAtTime extends Primitive {
	/** Type name of the primitive */
	public static final String PRIMITIVE_TYPE = "World::VectorAtTime";
	 ...
	 */
	public VectorAtTime(org.roboticsapi.facet.runtime.rpi.core.types.RPIdouble paramMaxAge) {
		this();
	 ...
	 * @param maxAge Maximum age supported (s)
	 */
	public VectorAtTime(Double paramMaxAge) {
	 ...
	 */
	public VectorAtTime(org.roboticsapi.facet.runtime.rpi.core.types.RPIdouble paramAge,
	 ...
	 * @param paramMaxAge Maximum age supported (s)
	 */
	public VectorAtTime(Double paramAge, Double paramMaxAge) {
