 ...
 */
public class IntInterNetcommIn extends Primitive {
	/** Type name of the primitive */
	public static final String PRIMITIVE_TYPE = "Core::IntInterNetcommIn";
	 ...
	 */
	public IntInterNetcommIn(org.roboticsapi.facet.runtime.rpi.core.types.RPIstring paramRemoteRCC,
	 ...
	 * @param remoteKey Key (unique name) of the remote property
	 */
	public IntInterNetcommIn(String paramRemoteRCC, String paramRemoteNet, String paramRemoteKey) {
