 ...
 * Creates an array.
 */
public class TwistArray extends Primitive {
	/** Type name of the primitive */
	public static final String PRIMITIVE_TYPE = "World::TwistArray";
	 ...
	 */
	public TwistArray(org.roboticsapi.facet.runtime.rpi.core.types.RPIint paramSize) {
		this();
	 ...
	 * @param size Size of the array
	 */
	public TwistArray(Integer paramSize) {
