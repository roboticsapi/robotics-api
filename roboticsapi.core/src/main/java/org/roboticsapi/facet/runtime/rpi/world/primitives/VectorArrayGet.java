 ...
 */
public class VectorArrayGet extends Primitive {
	/** Type name of the primitive */
	public static final String PRIMITIVE_TYPE = "World::VectorArrayGet";
	 ...
	 */
	public VectorArrayGet(org.roboticsapi.facet.runtime.rpi.core.types.RPIint paramSize,
	 ...
	 * @param index Item index
	 */
	public VectorArrayGet(Integer paramSize, Integer paramIndex) {
