 ...
 */
public class FrameArrayNetcommIn extends Primitive {
	/** Type name of the primitive */
	public static final String PRIMITIVE_TYPE = "World::FrameArrayNetcommIn";
	 ...
	 */
	public FrameArrayNetcommIn(org.roboticsapi.facet.runtime.rpi.core.types.RPIstring paramKey,
	 ...
	 * @param value Initial value to write to net
	 */
	public FrameArrayNetcommIn(String paramKey, String paramValue) {
