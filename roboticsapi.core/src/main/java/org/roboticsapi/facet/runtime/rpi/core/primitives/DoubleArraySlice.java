 ...
 */
public class DoubleArraySlice extends Primitive {
	/** Type name of the primitive */
	public static final String PRIMITIVE_TYPE = "Core::DoubleArraySlice";
	 ...
	 */
	public DoubleArraySlice(org.roboticsapi.facet.runtime.rpi.core.types.RPIint paramSize,
	 ...
	 * @param start Start index
	 */
	public DoubleArraySlice(Integer paramSize, Integer paramStart) {
