 ...
 * Sets an array value.
 */
public class BooleanArraySet extends Primitive {
	/** Type name of the primitive */
	public static final String PRIMITIVE_TYPE = "Core::BooleanArraySet";
	 ...
	 */
	public BooleanArraySet(org.roboticsapi.facet.runtime.rpi.core.types.RPIint paramSize,
	 ...
	 * @param index Item index
	 */
	public BooleanArraySet(Integer paramSize, Integer paramIndex) {
