 ...
 */
public class TwistArrayGet extends Primitive {
	/** Type name of the primitive */
	public static final String PRIMITIVE_TYPE = "World::TwistArrayGet";
	 ...
	 */
	public TwistArrayGet(org.roboticsapi.facet.runtime.rpi.core.types.RPIint paramSize,
	 ...
	 * @param index Item index
	 */
	public TwistArrayGet(Integer paramSize, Integer paramIndex) {
