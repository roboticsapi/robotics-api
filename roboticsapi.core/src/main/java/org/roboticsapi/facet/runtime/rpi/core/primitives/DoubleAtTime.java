 ...
 */
public class DoubleAtTime extends Primitive {
	/** Type name of the primitive */
	public static final String PRIMITIVE_TYPE = "Core::DoubleAtTime";
	 ...
	 */
	public DoubleAtTime(org.roboticsapi.facet.runtime.rpi.core.types.RPIdouble paramMaxAge) {
		this();
	 ...
	 * @param maxAge Maximum age supported (s)
	 */
	public DoubleAtTime(Double paramMaxAge) {
	 ...
	 */
	public DoubleAtTime(org.roboticsapi.facet.runtime.rpi.core.types.RPIdouble paramAge,
	 ...
	 * @param paramMaxAge Maximum age supported (s)
	 */
	public DoubleAtTime(Double paramAge, Double paramMaxAge) {
