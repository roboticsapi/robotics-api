...
import org.roboticsapi.facet.runtime.rpi.world.primitives.RotationNetcommOut;

/**
 * Communication module to read value from net
 */
public class ReadRotationFromNet extends RotationNetcommOut implements NetcommPrimitive {
	 ...
	 */
	public ReadRotationFromNet(final String key) {
		super(key);
