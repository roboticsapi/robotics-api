 ...
 */
public class WrenchArrayInterNetcommOut extends Primitive {
	/** Type name of the primitive */
	public static final String PRIMITIVE_TYPE = "World::WrenchArrayInterNetcommOut";
	...
	public WrenchArrayInterNetcommOut() {
	 ...
	 */
	public WrenchArrayInterNetcommOut(org.roboticsapi.facet.runtime.rpi.core.types.RPIstring paramRemoteRCC,
	 ...
	 * @param remoteKey Key (unique name) of the remote property
	 */
	public WrenchArrayInterNetcommOut(String paramRemoteRCC, String paramRemoteNet, String paramRemoteKey) {
