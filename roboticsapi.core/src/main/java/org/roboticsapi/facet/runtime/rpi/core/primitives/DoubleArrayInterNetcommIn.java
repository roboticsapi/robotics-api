 ...
 */
public class DoubleArrayInterNetcommIn extends Primitive {
	/** Type name of the primitive */
	public static final String PRIMITIVE_TYPE = "Core::DoubleArrayInterNetcommIn";
	...
	public DoubleArrayInterNetcommIn() {
	 ...
	 */
	public DoubleArrayInterNetcommIn(org.roboticsapi.facet.runtime.rpi.core.types.RPIstring paramRemoteRCC,
	 ...
	 * @param remoteKey Key (unique name) of the remote property
	 */
	public DoubleArrayInterNetcommIn(String paramRemoteRCC, String paramRemoteNet, String paramRemoteKey) {
