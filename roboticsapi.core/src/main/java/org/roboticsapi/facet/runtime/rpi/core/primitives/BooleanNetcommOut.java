...
public class BooleanNetcommOut extends Primitive {
	 ...
	 */
	public BooleanNetcommOut(org.roboticsapi.facet.runtime.rpi.core.types.RPIstring paramKey) {
		this();
	 ...
	 */
	public BooleanNetcommOut(org.roboticsapi.facet.runtime.rpi.core.types.RPIstring paramKey,
			org.roboticsapi.facet.runtime.rpi.core.types.RPIbool paramValue) {
		this();
	...
	public BooleanNetcommOut(String paramKey, Boolean paramValue) {
		this(new org.roboticsapi.facet.runtime.rpi.core.types.RPIstring(paramKey),
				new org.roboticsapi.facet.runtime.rpi.core.types.RPIbool(paramValue));
	}
