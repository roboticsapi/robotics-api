 ...
 */
public class VectorInterNetcommIn extends Primitive {
	/** Type name of the primitive */
	public static final String PRIMITIVE_TYPE = "World::VectorInterNetcommIn";
	 ...
	 */
	public VectorInterNetcommIn(org.roboticsapi.facet.runtime.rpi.core.types.RPIstring paramRemoteRCC,
	 ...
	 * @param remoteKey Key (unique name) of the remote property
	 */
	public VectorInterNetcommIn(String paramRemoteRCC, String paramRemoteNet, String paramRemoteKey) {
