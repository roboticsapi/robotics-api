 ...
 */
public class WrenchArraySlice extends Primitive {
	/** Type name of the primitive */
	public static final String PRIMITIVE_TYPE = "World::WrenchArraySlice";
	 ...
	 */
	public WrenchArraySlice(org.roboticsapi.facet.runtime.rpi.core.types.RPIint paramSize,
	 ...
	 * @param start Start index
	 */
	public WrenchArraySlice(Integer paramSize, Integer paramStart) {
