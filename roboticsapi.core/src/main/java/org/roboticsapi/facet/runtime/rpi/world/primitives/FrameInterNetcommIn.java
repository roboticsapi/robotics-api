 ...
 */
public class FrameInterNetcommIn extends Primitive {
	/** Type name of the primitive */
	public static final String PRIMITIVE_TYPE = "World::FrameInterNetcommIn";
	 ...
	 */
	public FrameInterNetcommIn(org.roboticsapi.facet.runtime.rpi.core.types.RPIstring paramRemoteRCC,
	 ...
	 * @param remoteKey Key (unique name) of the remote property
	 */
	public FrameInterNetcommIn(String paramRemoteRCC, String paramRemoteNet, String paramRemoteKey) {
