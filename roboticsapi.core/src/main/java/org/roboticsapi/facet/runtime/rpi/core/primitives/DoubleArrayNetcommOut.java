 ...
 */
public class DoubleArrayNetcommOut extends Primitive {
	/** Type name of the primitive */
	public static final String PRIMITIVE_TYPE = "Core::DoubleArrayNetcommOut";
	...
	private final Parameter<org.roboticsapi.facet.runtime.rpi.core.types.RPIdoubleArray> paramValue = new Parameter<org.roboticsapi.facet.runtime.rpi.core.types.RPIdoubleArray>(
			"Value", new org.roboticsapi.facet.runtime.rpi.core.types.RPIdoubleArray("[]"));

	public DoubleArrayNetcommOut() {
	 ...
	 */
	public DoubleArrayNetcommOut(org.roboticsapi.facet.runtime.rpi.core.types.RPIstring paramKey) {
		this();
	 ...
	 * @param key Key (unique name) of the property
	 */
	public DoubleArrayNetcommOut(String paramKey) {
	 ...
	 */
	public DoubleArrayNetcommOut(org.roboticsapi.facet.runtime.rpi.core.types.RPIstring paramKey,
			org.roboticsapi.facet.runtime.rpi.core.types.RPIdoubleArray paramValue) {
		this();
	 ...
	 * @param paramValue Initial value to read from net
	 */
	public DoubleArrayNetcommOut(String paramKey, String paramValue) {
		this(new org.roboticsapi.facet.runtime.rpi.core.types.RPIstring(paramKey),
				new org.roboticsapi.facet.runtime.rpi.core.types.RPIdoubleArray(paramValue));
	}
	 ...
	 * @return the parameter of the block
	 */
	public final Parameter<org.roboticsapi.facet.runtime.rpi.core.types.RPIdoubleArray> getValue() {
	 ...
	 * @param value new value of the parameter
	 */
	public final void setValue(org.roboticsapi.facet.runtime.rpi.core.types.RPIdoubleArray value) {
	...
	public final void setValue(String value) {
		this.setValue(new org.roboticsapi.facet.runtime.rpi.core.types.RPIdoubleArray(value));
	}
