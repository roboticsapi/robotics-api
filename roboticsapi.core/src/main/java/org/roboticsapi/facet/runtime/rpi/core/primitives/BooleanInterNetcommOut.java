 ...
 */
public class BooleanInterNetcommOut extends Primitive {
	/** Type name of the primitive */
	public static final String PRIMITIVE_TYPE = "Core::BooleanInterNetcommOut";
	 ...
	 */
	public BooleanInterNetcommOut(org.roboticsapi.facet.runtime.rpi.core.types.RPIstring paramRemoteRCC,
	 ...
	 * @param remoteKey Key (unique name) of the remote property
	 */
	public BooleanInterNetcommOut(String paramRemoteRCC, String paramRemoteNet, String paramRemoteKey) {
