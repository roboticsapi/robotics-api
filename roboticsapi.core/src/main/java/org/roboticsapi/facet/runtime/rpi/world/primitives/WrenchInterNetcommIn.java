 ...
 */
public class WrenchInterNetcommIn extends Primitive {
	/** Type name of the primitive */
	public static final String PRIMITIVE_TYPE = "World::WrenchInterNetcommIn";
	 ...
	 */
	public WrenchInterNetcommIn(org.roboticsapi.facet.runtime.rpi.core.types.RPIstring paramRemoteRCC,
	 ...
	 * @param remoteKey Key (unique name) of the remote property
	 */
	public WrenchInterNetcommIn(String paramRemoteRCC, String paramRemoteNet, String paramRemoteKey) {
