 ...
 */
public class VectorInterNetcommOut extends Primitive {
	/** Type name of the primitive */
	public static final String PRIMITIVE_TYPE = "World::VectorInterNetcommOut";
	 ...
	 */
	public VectorInterNetcommOut(org.roboticsapi.facet.runtime.rpi.core.types.RPIstring paramRemoteRCC,
	 ...
	 * @param remoteKey Key (unique name) of the remote property
	 */
	public VectorInterNetcommOut(String paramRemoteRCC, String paramRemoteNet, String paramRemoteKey) {
