...
import org.roboticsapi.facet.runtime.rpi.core.primitives.IntNetcommOut;
import org.roboticsapi.facet.runtime.rpi.core.types.RPIstring;

/**
 * Communication module to read value from net
 */
public class ReadIntFromNet extends IntNetcommOut implements NetcommPrimitive {
	 ...
	 */
	public ReadIntFromNet(final String key) {
		super(key);
