 ...
 * Creates an array.
 */
public class RotationArray extends Primitive {
	/** Type name of the primitive */
	public static final String PRIMITIVE_TYPE = "World::RotationArray";
	 ...
	 */
	public RotationArray(org.roboticsapi.facet.runtime.rpi.core.types.RPIint paramSize) {
		this();
	 ...
	 * @param size Size of the array
	 */
	public RotationArray(Integer paramSize) {
