 ...
 */
public class BooleanArrayInterNetcommOut extends Primitive {
	/** Type name of the primitive */
	public static final String PRIMITIVE_TYPE = "Core::BooleanArrayInterNetcommOut";
	...
	public BooleanArrayInterNetcommOut() {
	 ...
	 */
	public BooleanArrayInterNetcommOut(org.roboticsapi.facet.runtime.rpi.core.types.RPIstring paramRemoteRCC,
	 ...
	 * @param remoteKey Key (unique name) of the remote property
	 */
	public BooleanArrayInterNetcommOut(String paramRemoteRCC, String paramRemoteNet, String paramRemoteKey) {
