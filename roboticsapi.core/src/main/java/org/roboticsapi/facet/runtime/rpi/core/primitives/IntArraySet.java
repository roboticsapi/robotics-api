 ...
 * Sets an array value.
 */
public class IntArraySet extends Primitive {
	/** Type name of the primitive */
	public static final String PRIMITIVE_TYPE = "Core::IntArraySet";
	 ...
	 */
	public IntArraySet(org.roboticsapi.facet.runtime.rpi.core.types.RPIint paramSize,
	 ...
	 * @param index Item index
	 */
	public IntArraySet(Integer paramSize, Integer paramIndex) {
