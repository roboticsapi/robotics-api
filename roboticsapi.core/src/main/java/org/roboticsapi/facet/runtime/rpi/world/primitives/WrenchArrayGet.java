 ...
 */
public class WrenchArrayGet extends Primitive {
	/** Type name of the primitive */
	public static final String PRIMITIVE_TYPE = "World::WrenchArrayGet";
	 ...
	 */
	public WrenchArrayGet(org.roboticsapi.facet.runtime.rpi.core.types.RPIint paramSize,
	 ...
	 * @param index Item index
	 */
	public WrenchArrayGet(Integer paramSize, Integer paramIndex) {
