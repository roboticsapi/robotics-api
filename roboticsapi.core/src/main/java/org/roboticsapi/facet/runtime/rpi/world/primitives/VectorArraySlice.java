 ...
 */
public class VectorArraySlice extends Primitive {
	/** Type name of the primitive */
	public static final String PRIMITIVE_TYPE = "World::VectorArraySlice";
	 ...
	 */
	public VectorArraySlice(org.roboticsapi.facet.runtime.rpi.core.types.RPIint paramSize,
	 ...
	 * @param start Start index
	 */
	public VectorArraySlice(Integer paramSize, Integer paramStart) {
