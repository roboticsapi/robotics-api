...
public final class GetLinearVelocityFromTwistRealtimeVector extends RealtimeVector {

	private final RealtimeTwist twist;

	GetLinearVelocityFromTwistRealtimeVector(RealtimeTwist twist) {
		super(twist);
		this.twist = twist;
	}
	...
	public boolean equals(Object obj) {
		return classEqual(obj) && twist.equals(((GetLinearVelocityFromTwistRealtimeVector) obj).twist);
	}
