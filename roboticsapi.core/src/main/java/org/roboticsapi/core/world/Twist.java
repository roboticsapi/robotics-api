...
public class Twist {
	...
	public boolean equals(Object obj) {
		return obj instanceof Twist && rotVel.equals(((Twist) obj).rotVel) && transVel.equals(((Twist) obj).transVel);
	}

	@Override
	public int hashCode() {
		return HashCodeUtil.hash(HashCodeUtil.hash(HashCodeUtil.SEED, rotVel), transVel);
	}

	public Twist add(Twist other) {
		return new Twist(getTransVel().add(other.getTransVel()), getRotVel().add(other.getRotVel()));
	}
