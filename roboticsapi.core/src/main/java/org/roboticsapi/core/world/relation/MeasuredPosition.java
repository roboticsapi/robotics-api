...
public class MeasuredPosition extends GeometricRelation {

	private final RealtimeTransformation transformation;
	private final RealtimeTwist twist;

	public MeasuredPosition(Frame from, Frame to, RealtimeTransformation transformation, RealtimeTwist twist) {
		super(from, to);
