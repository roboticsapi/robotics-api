...
public interface RoboticsObjectBuilder extends Extension {
	 ...
	 * robotics builder. This method returns true at least for all names provided by
	 * {@link RoboticsObjectBuilder#getProvidedTypes()}
	 *
	 * @param type the type
	...
	/**
	 * Instantiates a robotics object of the given type. This method returns valid
	 * robotics objects at least for all types where
