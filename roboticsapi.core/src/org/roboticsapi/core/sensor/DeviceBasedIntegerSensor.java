...
/**
 * Abstract implementation for {@link IntegerSensor}s that are based on
 * {@link Device}s.
 *
 * @param <T> the device driver's type.
 */
public abstract class DeviceBasedIntegerSensor<T extends DeviceDriver> extends IntegerSensor {
	 ...
	 */
	public DeviceBasedIntegerSensor(final T driver) {
	...
	public boolean equals(Object obj) {
		return classEqual(obj) && driver.equals(((DeviceBasedIntegerSensor<?>) obj).driver) && equals2(obj);
	}
