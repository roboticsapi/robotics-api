...
/**
 * CommandErrorStrategy that cancels a command on unhandled errors.
 */
public class AbortCommandStrategy implements InnerExceptionStrategy {

	@Override
	public void handleException(Command command, CommandRealtimeException exception) throws RoboticsException {
		command.addExceptionHandler(exception.getClass(), new CommandStopper(command));
	}
