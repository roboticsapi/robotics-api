...
/**
 * Abstract implementation for {@link VectorSensor}s that are based on
 * {@link Device}s.
 *
 * @param <T> the device driver's type.
 */
public abstract class DeviceBasedVectorSensor<T extends DeviceDriver> extends VectorSensor {
	 ...
	 */
	public DeviceBasedVectorSensor(final T driver) {
	...
	public boolean equals(Object obj) {
		return classEqual(obj) && driver.equals(((DeviceBasedVectorSensor<?>) obj).driver) && equals2(obj);
	}
