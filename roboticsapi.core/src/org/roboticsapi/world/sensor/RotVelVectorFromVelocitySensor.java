...
public final class RotVelVectorFromVelocitySensor extends VectorSensor {

	private final VelocitySensor velocitySensor;

	public RotVelVectorFromVelocitySensor(VelocitySensor velocitySensor) {
	...
	public boolean equals(Object obj) {
		return classEqual(obj) && velocitySensor.equals(((RotVelVectorFromVelocitySensor) obj).velocitySensor);
	}
