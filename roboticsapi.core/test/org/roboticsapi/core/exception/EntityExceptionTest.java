...
public class EntityExceptionTest {
	...
	public void testConstructorWithStringArgumentSimpleTest() {
		assertNotNull(new EntityException("TestEntityException"));
	}

	@Test
	public void testConstructorWithStringAndExceptionArgumentsSimpleTest() {
		assertNotNull(new EntityException("TestEntityException", new Exception()));
	}

	@Test
	public void testConstructorWithExceptionArgumentsSimpleTest() {
		assertNotNull(new EntityException(new Exception()));
	}
}
