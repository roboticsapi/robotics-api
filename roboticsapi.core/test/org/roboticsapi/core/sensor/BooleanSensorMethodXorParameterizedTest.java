...
public class BooleanSensorMethodXorParameterizedTest {
	private final boolean testLeftValue;
	private final boolean testRightValue;
	private final boolean expectedResult;

	private BooleanFromJavaSensor testLeftSensor = null;

	public BooleanSensorMethodXorParameterizedTest(boolean left, boolean right, boolean expected) {
		testLeftValue = left;
	...
	@Before
	public void setup() {
		testLeftSensor = new BooleanFromJavaSensor(testLeftValue);
	}
	...
	public void testMethodNamedXorWithBooleanParameterWithParameterizedValuesExpectingCorrectXorResult() {
		assertEquals(expectedResult, testLeftSensor.xor(testRightValue).getCheapValue());
	}
}
