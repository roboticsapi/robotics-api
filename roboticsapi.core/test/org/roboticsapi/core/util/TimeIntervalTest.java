...
public class TimeIntervalTest {
	...
	public void testSimpleTimeInterval() {
		...
		Assert.assertEquals(Double.POSITIVE_INFINITY, interval.getStartAfter(2), 0.001);
	}
	...
	public void testAddSecondTimeInterval() {
		...
		Assert.assertEquals(Double.POSITIVE_INFINITY, interval.getStartAfter(4), 0.001);
	}
	...
	public void testAddTouchingIntervals() {
		...
		Assert.assertEquals(Double.POSITIVE_INFINITY, interval.getStartAfter(3), 0.001);
	}
	...
	public void testAddBothOverlappingInterval() {
		...
		Assert.assertEquals(Double.POSITIVE_INFINITY, interval.getStartAfter(6), 0.001);
	}
	...
	public void testRemoveEntireTimeInterval() {
		...
		Assert.assertEquals(Double.POSITIVE_INFINITY, interval.getFirstStart(), 0.001);
	}
	...
	public void testRemoveIntersectingInterval() {
		...
		Assert.assertEquals(Double.POSITIVE_INFINITY, interval.getStartAfter(10), 0.001);
	}
	...
	public void testUnionIntervals() {
		...
		Assert.assertEquals(Double.POSITIVE_INFINITY, union.getStartAfter(12), 0.001);
	}
	...
	public void testIntersectIntervals() {
		...
		Assert.assertEquals(Double.POSITIVE_INFINITY, intersect.getStartAfter(3), 0.001);
	}
	...
	public void testIntersectIntervals3() {
		...
		Assert.assertEquals(Double.POSITIVE_INFINITY, intersect.getStartAfter(7), 0.001);
	}
