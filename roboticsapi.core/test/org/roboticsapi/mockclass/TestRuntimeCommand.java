...
public class TestRuntimeCommand extends RuntimeCommand {
	...
	public TestRuntimeCommand(Action action, Actuator device) throws RoboticsException {
		this(action, device, new DeviceParameterBag());
	}

	public TestRuntimeCommand(Action action, Actuator device, DeviceParameterBag parameters) throws RoboticsException {
