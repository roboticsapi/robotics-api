...
import org.roboticsapi.runtime.platform.CartesianPositionConnection;
...
public class SoftRobotPlatformCartesianPositionDriver extends AbstractSoftRobotActuatorDriver
	...
	public Relation createNewOdometryRelation() {
		return new CartesianPositionConnection(this, getDeviceName());
	}
