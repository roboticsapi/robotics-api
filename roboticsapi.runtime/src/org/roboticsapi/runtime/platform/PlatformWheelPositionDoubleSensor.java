...
/**
 * {@link DoubleSensor} implementation for measuring the position of a wheel
 * using the {@link SoftRobotRobotBaseDriver}.
 */
public final class PlatformWheelPositionDoubleSensor extends DeviceBasedDoubleSensor<AbstractSoftRobotActuatorDriver> {
	 ...
	 */
	public PlatformWheelPositionDoubleSensor(AbstractSoftRobotActuatorDriver driver, int wheelNumber) {
		super(driver);
	...
	public boolean equals2(Object obj) {
		return wheelNumber == ((PlatformWheelPositionDoubleSensor) obj).wheelNumber;
	}
