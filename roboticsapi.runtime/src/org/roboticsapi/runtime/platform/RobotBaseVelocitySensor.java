...
public final class RobotBaseVelocitySensor extends VelocitySensor {

	private final PlatformDriver platformDriver;
	private final String deviceName;

	public RobotBaseVelocitySensor(PlatformDriver platformDriver, String deviceName, Frame from, Frame to) {
	...
	public boolean equals(Object obj) {
		return classEqual(obj) && platformDriver.equals(((RobotBaseVelocitySensor) obj).platformDriver)
				&& deviceName.equals(((RobotBaseVelocitySensor) obj).deviceName);
	}
