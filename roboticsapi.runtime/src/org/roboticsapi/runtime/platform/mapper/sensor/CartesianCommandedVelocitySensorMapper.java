...
public class CartesianCommandedVelocitySensorMapper
		implements SensorMapper<SoftRobotRuntime, Twist, CartesianCommandedVelocitySensor> {

	@Override
	public SensorMapperResult<Twist> map(SoftRobotRuntime runtime, CartesianCommandedVelocitySensor sensor,
		...
		DataflowOutPort sensorPort = fragment
				.addOutPort(
						...
						false, monitor.getOutCommandedVelocity());
