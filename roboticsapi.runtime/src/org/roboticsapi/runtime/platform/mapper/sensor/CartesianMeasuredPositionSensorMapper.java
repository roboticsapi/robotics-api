...
public class CartesianMeasuredPositionSensorMapper
		implements SensorMapper<SoftRobotRuntime, Transformation, CartesianMeasuredPositionSensor> {

	@Override
	public SensorMapperResult<Transformation> map(SoftRobotRuntime runtime, CartesianMeasuredPositionSensor sensor,
			SensorMappingPorts ports, SensorMappingContext context) throws MappingException {

		NetFragment fragment = new NetFragment("CartesianMeasuredPositionSensor");
		...
		return new TransformationSensorMapperResult(fragment,
				fragment.addOutPort(new TransformationDataflow(), false, monitor.getOutMeasuredPosition()));
	}
}
