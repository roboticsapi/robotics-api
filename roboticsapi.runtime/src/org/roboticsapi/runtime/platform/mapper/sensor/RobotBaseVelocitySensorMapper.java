...
public class RobotBaseVelocitySensorMapper implements SensorMapper<SoftRobotRuntime, Twist, RobotBaseVelocitySensor> {

	@Override
	public SensorMapperResult<Twist> map(SoftRobotRuntime runtime, RobotBaseVelocitySensor sensor,
		...
		DataflowOutPort sensorPort = monitorFragment.addOutPort(new VelocityDataflow(odometryFrame, odometryOrigin,
				odometryFrame.getPoint(), odometryFrame.getOrientation()), false, monitor.getOutVel());
