...
public class FollowFrameMapper implements ActionMapper<SoftRobotRuntime, FollowFrame> {

	@Override
	public ActionMapperResult map(SoftRobotRuntime runtime, FollowFrame action, DeviceParameterBag parameters,
		...
		return new FollowFrameMapperResult(action, fragment, result, ports.cancelPort);
	}
