...
public class DriveVelocityMapperResult extends BaseActionMapperResult {

	public DriveVelocityMapperResult(Action action, NetFragment fragment, ActionResult result, DataflowOutPort cancel) {
