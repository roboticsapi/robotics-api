...
public class TransVelFromVelocitySensorMapper
		implements SensorMapper<AbstractMapperRuntime, Vector, TransVelVectorFromVelocitySensor> {

	@Override
	public SensorMapperResult<Vector> map(AbstractMapperRuntime runtime, TransVelVectorFromVelocitySensor sensor,
		...
		DataflowOutPort sensorPort = fragment.addOutPort(new VectorDataflow(), true, split.getOutTransVel());
