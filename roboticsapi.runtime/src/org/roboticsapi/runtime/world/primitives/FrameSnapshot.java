 ...
 * true)
 */
public class FrameSnapshot extends Primitive {
	/** Type name of the primitive */
	public static final String PRIMITIVE_TYPE = "World::FrameSnapshot";
	 ...
	 */
	public FrameSnapshot(org.roboticsapi.runtime.world.types.RPIFrame paramValue) {
		this();
	 ...
	 * @param paramValue Initial value
	 */
	public FrameSnapshot(String paramValue) {
		this(new org.roboticsapi.runtime.world.types.RPIFrame(paramValue));
	}
