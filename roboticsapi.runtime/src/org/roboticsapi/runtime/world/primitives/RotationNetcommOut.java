 ...
 */
public class RotationNetcommOut extends Primitive {
	/** Type name of the primitive */
	public static final String PRIMITIVE_TYPE = "World::RotationNetcommOut";
	 ...
	 */
	public RotationNetcommOut(org.roboticsapi.runtime.core.types.RPIstring paramKey) {
		this();
	 ...
	 * @param key Key (unique name) of the property
	 */
	public RotationNetcommOut(String paramKey) {
	 ...
	 */
	public RotationNetcommOut(org.roboticsapi.runtime.core.types.RPIstring paramKey,
			org.roboticsapi.runtime.world.types.RPIRotation paramValue) {
		this();
	 ...
	 * @param paramValue Initial value to read from net
	 */
	public RotationNetcommOut(String paramKey, String paramValue) {
		this(new org.roboticsapi.runtime.core.types.RPIstring(paramKey),
				new org.roboticsapi.runtime.world.types.RPIRotation(paramValue));
	}
