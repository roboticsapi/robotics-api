...
public class TwistArrayNetcommOut extends Primitive {
	...
	private final Parameter<org.roboticsapi.runtime.world.types.RPITwistArray> paramValue = new Parameter<org.roboticsapi.runtime.world.types.RPITwistArray>(
			"Value", new org.roboticsapi.runtime.world.types.RPITwistArray("[]"));
	 ...
	 */
	public TwistArrayNetcommOut(org.roboticsapi.runtime.core.types.RPIstring paramKey) {
		this();
	 ...
	 */
	public TwistArrayNetcommOut(org.roboticsapi.runtime.core.types.RPIstring paramKey,
			org.roboticsapi.runtime.world.types.RPITwistArray paramValue) {
		this();
	...
	public TwistArrayNetcommOut(String paramKey, String paramValue) {
		this(new org.roboticsapi.runtime.core.types.RPIstring(paramKey),
				new org.roboticsapi.runtime.world.types.RPITwistArray(paramValue));
	}
	 ...
	 * @return the parameter of the block
	 */
	public final Parameter<org.roboticsapi.runtime.world.types.RPITwistArray> getValue() {
	 ...
	 * @param value new value of the parameter
	 */
	public final void setValue(org.roboticsapi.runtime.world.types.RPITwistArray value) {
	...
	public final void setValue(String value) {
		this.setValue(new org.roboticsapi.runtime.world.types.RPITwistArray(value));
	}
