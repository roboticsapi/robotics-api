...
public class FrameNetcommOut extends Primitive {
	 ...
	 */
	public FrameNetcommOut(org.roboticsapi.runtime.core.types.RPIstring paramKey) {
		this();
	 ...
	 * @param key Key (unique name) of the property
	 */
	public FrameNetcommOut(String paramKey) {
	 ...
	 * @param paramValue Initial value to read from net
	 */
	public FrameNetcommOut(String paramKey, String paramValue) {
		this(new org.roboticsapi.runtime.core.types.RPIstring(paramKey),
