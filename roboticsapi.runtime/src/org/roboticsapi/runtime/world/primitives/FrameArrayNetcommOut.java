...
public class FrameArrayNetcommOut extends Primitive {
	...
	private final Parameter<org.roboticsapi.runtime.world.types.RPIFrameArray> paramValue = new Parameter<org.roboticsapi.runtime.world.types.RPIFrameArray>(
			"Value", new org.roboticsapi.runtime.world.types.RPIFrameArray("[]"));
	 ...
	 */
	public FrameArrayNetcommOut(org.roboticsapi.runtime.core.types.RPIstring paramKey) {
		this();
	 ...
	 */
	public FrameArrayNetcommOut(org.roboticsapi.runtime.core.types.RPIstring paramKey,
			org.roboticsapi.runtime.world.types.RPIFrameArray paramValue) {
		this();
	...
	public FrameArrayNetcommOut(String paramKey, String paramValue) {
		this(new org.roboticsapi.runtime.core.types.RPIstring(paramKey),
				new org.roboticsapi.runtime.world.types.RPIFrameArray(paramValue));
	}
	 ...
	 * @return the parameter of the block
	 */
	public final Parameter<org.roboticsapi.runtime.world.types.RPIFrameArray> getValue() {
	 ...
	 * @param value new value of the parameter
	 */
	public final void setValue(org.roboticsapi.runtime.world.types.RPIFrameArray value) {
	...
	public final void setValue(String value) {
		this.setValue(new org.roboticsapi.runtime.world.types.RPIFrameArray(value));
	}
