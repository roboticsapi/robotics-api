 ...
 */
public class RotationArrayNetcommOut extends Primitive {
	/** Type name of the primitive */
	public static final String PRIMITIVE_TYPE = "World::RotationArrayNetcommOut";
	...
	private final Parameter<org.roboticsapi.runtime.world.types.RPIRotationArray> paramValue = new Parameter<org.roboticsapi.runtime.world.types.RPIRotationArray>(
			"Value", new org.roboticsapi.runtime.world.types.RPIRotationArray("[]"));

	public RotationArrayNetcommOut() {
	 ...
	 */
	public RotationArrayNetcommOut(org.roboticsapi.runtime.core.types.RPIstring paramKey) {
		this();
	 ...
	 * @param key Key (unique name) of the property
	 */
	public RotationArrayNetcommOut(String paramKey) {
	 ...
	 */
	public RotationArrayNetcommOut(org.roboticsapi.runtime.core.types.RPIstring paramKey,
			org.roboticsapi.runtime.world.types.RPIRotationArray paramValue) {
		this();
	 ...
	 * @param paramValue Initial value to read from net
	 */
	public RotationArrayNetcommOut(String paramKey, String paramValue) {
		this(new org.roboticsapi.runtime.core.types.RPIstring(paramKey),
				new org.roboticsapi.runtime.world.types.RPIRotationArray(paramValue));
	}
	 ...
	 * @return the parameter of the block
	 */
	public final Parameter<org.roboticsapi.runtime.world.types.RPIRotationArray> getValue() {
	 ...
	 * @param value new value of the parameter
	 */
	public final void setValue(org.roboticsapi.runtime.world.types.RPIRotationArray value) {
	...
	public final void setValue(String value) {
		this.setValue(new org.roboticsapi.runtime.world.types.RPIRotationArray(value));
	}
