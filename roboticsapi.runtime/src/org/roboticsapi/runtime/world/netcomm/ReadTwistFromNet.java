...
import org.roboticsapi.runtime.world.primitives.TwistNetcommOut;

/**
 * Communication module to read value from net
 */
public class ReadTwistFromNet extends TwistNetcommOut implements NetcommPrimitive {
	 ...
	 */
	public ReadTwistFromNet(final String key) {
		super(key);
