...
public class PersistedTransformationArraySensor extends TransformationArraySensor {

	private final Command command;
	private final NetcommValue key;

	public PersistedTransformationArraySensor(Command command, int size, NetcommValue key) {
