...
public class OutReal extends Primitive {
	...
	private final Parameter<org.roboticsapi.runtime.core.types.RPIdouble> paramIO = new Parameter<org.roboticsapi.runtime.core.types.RPIdouble>(
			"IO", new org.roboticsapi.runtime.core.types.RPIdouble("0"));
	 ...
	 */
	public OutReal(org.roboticsapi.runtime.core.types.RPIstring paramDeviceID,
	 ...
	 */
	public OutReal(org.roboticsapi.runtime.core.types.RPIstring paramDeviceID,
			org.roboticsapi.runtime.core.types.RPIint paramPort, org.roboticsapi.runtime.core.types.RPIdouble paramIO) {
		this();
	...
	public OutReal(String paramDeviceID, Integer paramPort, Double paramIO) {
		this(new org.roboticsapi.runtime.core.types.RPIstring(paramDeviceID),
				new org.roboticsapi.runtime.core.types.RPIint(paramPort),
				new org.roboticsapi.runtime.core.types.RPIdouble(paramIO));
	}
	 ...
	 * @return the parameter of the block
	 */
	public final Parameter<org.roboticsapi.runtime.core.types.RPIdouble> getIO() {
		return this.paramIO;
	}
	 ...
	 * @param value new value of the parameter
	 */
	public final void setIO(org.roboticsapi.runtime.core.types.RPIdouble value) {
	...
	public final void setIO(Double value) {
		this.setIO(new org.roboticsapi.runtime.core.types.RPIdouble(value));
	}
