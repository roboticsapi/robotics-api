...
public class OutBool extends Primitive {
	...
	private final Parameter<org.roboticsapi.runtime.core.types.RPIbool> paramIO = new Parameter<org.roboticsapi.runtime.core.types.RPIbool>(
			"IO", new org.roboticsapi.runtime.core.types.RPIbool("false"));
	 ...
	 */
	public OutBool(org.roboticsapi.runtime.core.types.RPIstring paramDeviceID,
	 ...
	 */
	public OutBool(org.roboticsapi.runtime.core.types.RPIstring paramDeviceID,
			org.roboticsapi.runtime.core.types.RPIint paramPort, org.roboticsapi.runtime.core.types.RPIbool paramIO) {
		this();
	...
	public OutBool(String paramDeviceID, Integer paramPort, Boolean paramIO) {
		this(new org.roboticsapi.runtime.core.types.RPIstring(paramDeviceID),
				new org.roboticsapi.runtime.core.types.RPIint(paramPort),
				new org.roboticsapi.runtime.core.types.RPIbool(paramIO));
	}
	 ...
	 * @return the parameter of the block
	 */
	public final Parameter<org.roboticsapi.runtime.core.types.RPIbool> getIO() {
		return this.paramIO;
	}
	 ...
	 * @param value new value of the parameter
	 */
	public final void setIO(org.roboticsapi.runtime.core.types.RPIbool value) {
	...
	public final void setIO(Boolean value) {
		this.setIO(new org.roboticsapi.runtime.core.types.RPIbool(value));
	}
