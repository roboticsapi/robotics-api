...
public class MirrorDigitalValueMapper implements ActionMapper<SoftRobotRuntime, MirrorDigitalValue> {

	@Override
	public ActionMapperResult map(SoftRobotRuntime runtime, MirrorDigitalValue action, DeviceParameterBag parameters,
			ActionMappingContext ports) throws MappingException, RPIException {
		final NetFragment fragment = new NetFragment("Mirror Digital Value");
