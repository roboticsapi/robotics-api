...
import org.roboticsapi.runtime.controlcore.dioprotocol.DIOCommand;
import org.roboticsapi.runtime.controlcore.dioprotocol.DIOProtocol;
import org.roboticsapi.runtime.controlcore.dioprotocol.DIOString;
...
public class WebsocketProtocol extends DIOProtocol {
	...
	private synchronized void writeWebsocket(int opcode, String data) throws IOException {
		if (DEBUG) {
			System.out.println(System.currentTimeMillis() + " " + name + ">>" + opcode + ":" + data);
		}
	...
	protected void readOne() {
		...
		try {
			while (true) {
				...
				if (DEBUG) {
					System.out
							.println(System.currentTimeMillis() + " " + name + "<<" + opcode + ":" + new String(data));
				}
