 ...
 */
public class IntNetcommOut extends Primitive {
	/** Type name of the primitive */
	public static final String PRIMITIVE_TYPE = "Core::IntNetcommOut";
	 ...
	 */
	public IntNetcommOut(org.roboticsapi.runtime.core.types.RPIstring paramKey) {
		this();
	 ...
	 * @param key Key (unique name) of the property
	 */
	public IntNetcommOut(String paramKey) {
	 ...
	 */
	public IntNetcommOut(org.roboticsapi.runtime.core.types.RPIstring paramKey,
			org.roboticsapi.runtime.core.types.RPIint paramValue) {
		this();
	 ...
	 * @param paramValue Initial value to read from net
	 */
	public IntNetcommOut(String paramKey, Integer paramValue) {
		this(new org.roboticsapi.runtime.core.types.RPIstring(paramKey),
				new org.roboticsapi.runtime.core.types.RPIint(paramValue));
	}
