 ...
 */
public class DoubleCos extends Primitive {
	/** Type name of the primitive */
	public static final String PRIMITIVE_TYPE = "Core::DoubleCos";
	...
	/**
	 * Creates calculates the cosine
	 *
	 * @param paramValue Value
	 */
	public DoubleCos(RPIdouble paramValue) {
		this();
	 ...
	 * @param paramValue Value
	 */
	public DoubleCos(Double paramValue) {
