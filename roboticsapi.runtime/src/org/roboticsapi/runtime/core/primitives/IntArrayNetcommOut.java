 ...
 */
public class IntArrayNetcommOut extends Primitive {
	/** Type name of the primitive */
	public static final String PRIMITIVE_TYPE = "Core::IntArrayNetcommOut";
	...
	private final Parameter<org.roboticsapi.runtime.core.types.RPIintArray> paramValue = new Parameter<org.roboticsapi.runtime.core.types.RPIintArray>(
			"Value", new org.roboticsapi.runtime.core.types.RPIintArray("[]"));

	public IntArrayNetcommOut() {
	 ...
	 */
	public IntArrayNetcommOut(org.roboticsapi.runtime.core.types.RPIstring paramKey) {
		this();
	 ...
	 * @param key Key (unique name) of the property
	 */
	public IntArrayNetcommOut(String paramKey) {
	 ...
	 */
	public IntArrayNetcommOut(org.roboticsapi.runtime.core.types.RPIstring paramKey,
			org.roboticsapi.runtime.core.types.RPIintArray paramValue) {
		this();
	 ...
	 * @param paramValue Initial value to read from net
	 */
	public IntArrayNetcommOut(String paramKey, String paramValue) {
		this(new org.roboticsapi.runtime.core.types.RPIstring(paramKey),
				new org.roboticsapi.runtime.core.types.RPIintArray(paramValue));
	}
	 ...
	 * @return the parameter of the block
	 */
	public final Parameter<org.roboticsapi.runtime.core.types.RPIintArray> getValue() {
	 ...
	 * @param value new value of the parameter
	 */
	public final void setValue(org.roboticsapi.runtime.core.types.RPIintArray value) {
	...
	public final void setValue(String value) {
		this.setValue(new org.roboticsapi.runtime.core.types.RPIintArray(value));
	}
