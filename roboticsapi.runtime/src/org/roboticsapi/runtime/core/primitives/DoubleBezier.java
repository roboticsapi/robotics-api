...
public class DoubleBezier extends Primitive {
	...
	/** Velocity at start position */
	private final Parameter<org.roboticsapi.runtime.core.types.RPIdouble> paramFromVel = new Parameter<org.roboticsapi.runtime.core.types.RPIdouble>(
			"FromVel", new org.roboticsapi.runtime.core.types.RPIdouble("0"));

	/** Velocity at destination position */
	private final Parameter<org.roboticsapi.runtime.core.types.RPIdouble> paramToVel = new Parameter<org.roboticsapi.runtime.core.types.RPIdouble>(
			"ToVel", new org.roboticsapi.runtime.core.types.RPIdouble("0"));
	 ...
	 */
	public DoubleBezier(org.roboticsapi.runtime.core.types.RPIdouble paramFrom,
			org.roboticsapi.runtime.core.types.RPIdouble paramTo, org.roboticsapi.runtime.core.types.RPIdouble paramFromVel,
			org.roboticsapi.runtime.core.types.RPIdouble paramToVel) {
		this();
	...
	public DoubleBezier(Double paramFrom, Double paramTo, Double paramFromVel, Double paramToVel) {
		this(new org.roboticsapi.runtime.core.types.RPIdouble(paramFrom),
				...
				new org.roboticsapi.runtime.core.types.RPIdouble(paramFromVel),
				new org.roboticsapi.runtime.core.types.RPIdouble(paramToVel));
	}
	 ...
	 * @return the parameter of the block
	 */
	public final Parameter<org.roboticsapi.runtime.core.types.RPIdouble> getFromVel() {
	 ...
	 * @param value new value of the parameter
	 */
	public final void setFromVel(org.roboticsapi.runtime.core.types.RPIdouble value) {
	...
	public final void setFromVel(Double value) {
		this.setFromVel(new org.roboticsapi.runtime.core.types.RPIdouble(value));
	}
	 ...
	 * @return the parameter of the block
	 */
	public final Parameter<org.roboticsapi.runtime.core.types.RPIdouble> getToVel() {
	 ...
	 * @param value new value of the parameter
	 */
	public final void setToVel(org.roboticsapi.runtime.core.types.RPIdouble value) {
	...
	public final void setToVel(Double value) {
		this.setToVel(new org.roboticsapi.runtime.core.types.RPIdouble(value));
	}
