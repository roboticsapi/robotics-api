...
public class EdgeDetection extends Primitive {
	...
	/** Direction of edge */
	private final Parameter<org.roboticsapi.runtime.core.types.RPIbool> paramDirection = new Parameter<org.roboticsapi.runtime.core.types.RPIbool>(
			"Direction", new org.roboticsapi.runtime.core.types.RPIbool("true"));
	 ...
	 */
	public EdgeDetection(org.roboticsapi.runtime.core.types.RPIbool paramDirection) {
		this();
	...
	public EdgeDetection(Boolean paramDirection) {
		this(new org.roboticsapi.runtime.core.types.RPIbool(paramDirection));
	}
	 ...
	 */
	public final Parameter<org.roboticsapi.runtime.core.types.RPIbool> getDirection() {
	 ...
	 */
	public final void setDirection(org.roboticsapi.runtime.core.types.RPIbool value) {
	...
	public final void setDirection(Boolean value) {
		this.setDirection(new org.roboticsapi.runtime.core.types.RPIbool(value));
	}
