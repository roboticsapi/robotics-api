 ...
 * An addition module
 */
public class IntAdd extends Primitive {
	/** Type name of the primitive */
	public static final String PRIMITIVE_TYPE = "Core::IntAdd";
	...
	/**
	 * Creates an addition module
	 *
	 * @param paramFirst  First value
	 * @param paramSecond Second value
	 */
	public IntAdd(org.roboticsapi.runtime.core.types.RPIint paramFirst, org.roboticsapi.runtime.core.types.RPIint paramSecond) {
		this();
	 ...
	 * @param paramSecond Second value
	 */
	public IntAdd(Integer paramFirst, Integer paramSecond) {
