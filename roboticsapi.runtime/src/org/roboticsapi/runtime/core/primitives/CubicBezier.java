...
public class CubicBezier extends Primitive {
	...
	/** First control position */
	private final Parameter<org.roboticsapi.runtime.core.types.RPIdouble> paramControl1 = new Parameter<org.roboticsapi.runtime.core.types.RPIdouble>(
			"Control1", new org.roboticsapi.runtime.core.types.RPIdouble("0"));

	/** Second control position */
	private final Parameter<org.roboticsapi.runtime.core.types.RPIdouble> paramControl2 = new Parameter<org.roboticsapi.runtime.core.types.RPIdouble>(
			"Control2", new org.roboticsapi.runtime.core.types.RPIdouble("0"));
	 ...
	 */
	public CubicBezier(org.roboticsapi.runtime.core.types.RPIdouble paramFrom,
			org.roboticsapi.runtime.core.types.RPIdouble paramTo, org.roboticsapi.runtime.core.types.RPIdouble paramControl1,
			org.roboticsapi.runtime.core.types.RPIdouble paramControl2) {
		this();
	...
	public CubicBezier(Double paramFrom, Double paramTo, Double paramControl1, Double paramControl2) {
		this(new org.roboticsapi.runtime.core.types.RPIdouble(paramFrom),
				...
				new org.roboticsapi.runtime.core.types.RPIdouble(paramControl1),
				new org.roboticsapi.runtime.core.types.RPIdouble(paramControl2));
	}
	 ...
	 * @return the parameter of the block
	 */
	public final Parameter<org.roboticsapi.runtime.core.types.RPIdouble> getControl1() {
	 ...
	 * @param value new value of the parameter
	 */
	public final void setControl1(org.roboticsapi.runtime.core.types.RPIdouble value) {
	...
	public final void setControl1(Double value) {
		this.setControl1(new org.roboticsapi.runtime.core.types.RPIdouble(value));
	}
	 ...
	 * @return the parameter of the block
	 */
	public final Parameter<org.roboticsapi.runtime.core.types.RPIdouble> getControl2() {
	 ...
	 * @param value new value of the parameter
	 */
	public final void setControl2(org.roboticsapi.runtime.core.types.RPIdouble value) {
	...
	public final void setControl2(Double value) {
		this.setControl2(new org.roboticsapi.runtime.core.types.RPIdouble(value));
	}
