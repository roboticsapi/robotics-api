...
public class Rampify extends Primitive {
	...
	private final Parameter<org.roboticsapi.runtime.core.types.RPIdouble> paramConstant = new Parameter<org.roboticsapi.runtime.core.types.RPIdouble>(
			"Constant", new org.roboticsapi.runtime.core.types.RPIdouble("0.5"));
	 ...
	 */
	public Rampify(org.roboticsapi.runtime.core.types.RPIdouble paramConstant) {
		this();
	...
	public Rampify(Double paramConstant) {
		this(new org.roboticsapi.runtime.core.types.RPIdouble(paramConstant));
	}
	 ...
	 */
	public final Parameter<org.roboticsapi.runtime.core.types.RPIdouble> getConstant() {
	 ...
	 */
	public final void setConstant(org.roboticsapi.runtime.core.types.RPIdouble value) {
	...
	public final void setConstant(Double value) {
		this.setConstant(new org.roboticsapi.runtime.core.types.RPIdouble(value));
	}
