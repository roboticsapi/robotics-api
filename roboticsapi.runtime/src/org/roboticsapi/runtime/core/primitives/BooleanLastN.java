...
public class BooleanLastN extends Primitive {
	...
	private final Parameter<org.roboticsapi.runtime.core.types.RPIint> paramCount = new Parameter<org.roboticsapi.runtime.core.types.RPIint>(
			"Count", new org.roboticsapi.runtime.core.types.RPIint("1"));
	 ...
	 */
	public BooleanLastN(org.roboticsapi.runtime.core.types.RPIint paramCount) {
		this();
	...
	public BooleanLastN(Integer paramCount) {
		this(new org.roboticsapi.runtime.core.types.RPIint(paramCount));
	}
	 ...
	 */
	public final Parameter<org.roboticsapi.runtime.core.types.RPIint> getCount() {
	 ...
	 */
	public final void setCount(org.roboticsapi.runtime.core.types.RPIint value) {
	...
	public final void setCount(Integer value) {
		this.setCount(new org.roboticsapi.runtime.core.types.RPIint(value));
	}
