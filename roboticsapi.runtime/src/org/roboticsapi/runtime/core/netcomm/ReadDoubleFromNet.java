...
import org.roboticsapi.runtime.core.primitives.DoubleNetcommOut;
 ...
 */
public class ReadDoubleFromNet extends DoubleNetcommOut implements NetcommPrimitive {
	 ...
	 */
	public ReadDoubleFromNet(final String key) {
		super(key);
